    ...
    <section className="relative z-10 md:pl-[122px] pl-5 pt-20 md:pt-[140px]">
      <div className="">
        <div className="w-full max-w-[750px]">
            <h2 className="fade-up md:text-[64px] text-[32px] font-bold italic border-b border-white">About TEXC</h2>
            <p className="fade-up md:text-[16px] text-[13px] md:pt-10 pt-5 tracking-wider">
