...
const Item = ({children}: {children: ReactNode}) => (
    <div className="flex items-center text-[4vw] md:text-[20px] xl:text-[28px] font-bold gap-4">
  ...
  return (
    ...
    >
      <div className="w-full max-w-[1440px] mx-auto">
        <h3 className="md:text-[80px] text-[12vw] font-semibold text-center md:leading-loose tracking-wider">今、どんな気持ちですか？</h3>
        <div className="flex justify-between w-full max-w-[1200px] mx-auto md:mt-20 mt-[10vw] gap-10 max-md:flex-wrap">
            <div className="flex max-md:justify-center gap-10 max-md:w-[calc(50%-20px)]">
            ...
            <div className="flex max-md:justify-center gap-10 max-md:w-[calc(50%-20px)] max-md:order-2">
        ...
        <div className="md:mt-16 mt-[10vw] md:mb-[186px] mb-[20vw]">
            <p className="text-center text-[5vw] md:text-[36px] font-semibold tracking-[0.2em]">
                3分の診断で、<br />
                あなたの経営難題に即答します
            </p>
            <div className="mt-[5vw] md:mt-10 flex justify-center">
              <a
                href="/"
