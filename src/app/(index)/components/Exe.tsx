  ...
  return (
    <section className="md:mt-[6vw] mt-[6rem]">
      ...
      <div className="flex gap-[5%] max-md:flex-col max-md:gap-20 js-list">
        ...
        <div className="pr-[5%] w-1/2 relative z-10 max-md:w-full max-md:pl-12 max-md:pr-[3re] js-list before:absolute before:bottom-[0] before:right-[12%] before:content-[''] before:w-[42%] before:[aspect-ratio:260/374] before:bg-[url(/assets/img/ico_ilst-2.svg)] before:bg-no-repeat before:bg-center before:bg-contain max-md:before:w-[28%] max-md:before:-bottom-16">
