...
const Howto = () => {
  return (
    <section className="md:mt-[238px] mt-[120px]">
        ...
        <div className="flex justify-center pt-12 pb-16 md:pt-20 md:pb-[100px] px-5">
            <Button />
        </div>
    </section>
  );
