    ...
    >
        <div ref={sliderRef} className="w-full max-w-[1440px] mx-auto md:px-10 md:pt-[72px] pt-10 relative">
            <div className="panel max-md:hidden z-10 absolute w-[22.56944%] top-[-5%] left-[43.5%]">
                <img className="w-full max-w-none" src="/assets/images/intro-img-01.png" alt="" />
            </div>
            <div className="panel max-md:hidden z-10 absolute w-[22.22%] top-[38%] left-[1%]">
                <img className="w-full max-w-none" src="/assets/images/intro-img-02.png" alt="" />
            </div>
            <div className="panel max-md:hidden z-10 absolute w-[24.514%] top-[77%] left-[6%]">
                <img className="w-full max-w-none" src="/assets/images/intro-img-03.png" alt="" />
            </div>
            <div className="panel max-md:hidden z-10 absolute w-[17.361%] top-[33.5%] left-[80%]">
                <img className="w-full max-w-none" src="/assets/images/intro-img-04.png" alt="" />
            </div>
            <div ref={ref} className="bg-white md:rounded-[100px] rounded-[60px] md:pt-[160px] pt-20 px-5">
                ...
                <h3 className="text-center xl:text-[96px] md:text-[72px] text-[36px] leading-none relative z-20 max-md:mt-10">
                Let's turn advertising operations into <span className="u-text-gradient font-bold">AI</span>.
                </h3>
                <h3 className="text-center xl:text-[96px] md:text-[72px] text-[36px] leading-none md:pt-20 pt-12 relative z-20">
                    Let's <br />
                    <span className="u-text-gradient font-bold">REDUCE WASTE</span><br />
                    even more.
                </h3>
                <p className="md:text-[20px] text-[16px] w-full max-w-[740px] mx-auto md:mt-20 mt-12  relative z-20 max-md:mb-10 [text-shadow:0_0_3px_#fff]">
