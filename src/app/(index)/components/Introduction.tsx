  ...
  return (
    ...
    >
      <div data-scroll className="w-full max-w-[1120px] mx-auto">
        <div className="fade-up flex justify-center items-center"><img className="max-md:w-[140px]" src="/assets/images/logo-weth.png" alt="" /></div>
        ...
        allows for the swapping of dwETH tokens.
        </h2>
      </div>
    </section>
  );
