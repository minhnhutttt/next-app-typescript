    ...
    >
      <div className="w-full max-w-[1000px] mx-auto flex">
       <div className="fade-up w-[417px] p-px u-gradient flex rounded-[30px]">
        <div className="bg-white bg-[url(/assets/images/wing.png)] bg-no-repeat bg-center bg-contain w-full h-full rounded-[30px] px-7 md:py-[56px] py-8 md:px-11 md:text-[20px] text-[16px] leading-loose tracking-wider">
