    ...
    >
      <div className="w-full max-w-[1360px] mx-auto md:pt-14 pt-10 md:pb-16 pb-12">
        <div className="flex items-center w-full max-w-[1040px] mx-auto xl:gap-[94px] md:gap-16 gap-10 max-md:flex-col md:mb-[90px] mb-12">
          <p className="md:text-[32px] text-[20px] font-extrabold italic">
          What is AIAD Coin?
          </p>
        ...
        <h5 className="text-center md:text-[40px] text-[24px] font-bold">Main features</h5>
        <div className="grid sm:grid-cols-2 justify-center xl:grid-cols-4 gap-[26px] md:mt-7 mt-5">
          {data.map((item, index) => (
            <div className="md:h-[370px] h-[330px] rounded-[20px] md:py-[60px] py-10 px-[18px] border border-black/10 bg-white/90 [box-shadow:0px_0px_33.484px_0px_rgba(38,_64,_141,_0.10)]" key={index}>
