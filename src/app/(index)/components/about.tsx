...
const About = () => {
  return (
    <section className="md:-mt-5 mt-8 overflow-hidden">
      <div className="w-full max-w-[1440px] mx-auto  bg-[url('/assets/images/about-map.png')] bg-center md:bg-top bg-no-repeat max-md:bg-contain pt-[32px] md:pb-[100px] pb-[100px]">
        <div className="md:space-y-20 space-y-14">
            <div className="flex md:items-end max-md:flex-col">
                <figure className="md:rounded-r-[60px] overflow-hidden dt:flex-[0_0_780px] flex-[0_0_54.167vw]">
                    <img src="/assets/images/about-img.png" alt="" />
                </figure>
                <div className="max-md:mt-10 md:ml-[-15.278vw] dt:ml-[-220px] dt:text-[48px] text-[20px] md:text-[3.333vw] leading-none flex flex-col items-center md:items-end whitespace-nowrap font-bold md:pr-10 md:pb-5 space-y-2.5">
            ...
            <div className="flex md:items-center max-md:flex-col md:flex-row-reverse">
                <figure className="md:rounded-l-[60px] overflow-hidden dt:flex-[0_0_780px] flex-[0_0_54.167vw]">
                    <img src="/assets/images/about-img-2.png" alt="" />
                </figure>
                <div className="max-md:mt-10 dt:text-[24px] text-[16px] md:text-[1.667vw] leading-loose flex flex-col items-center md:items-end font-bold px-5 md:px-10 md:pb-5 space-y-2.5">
