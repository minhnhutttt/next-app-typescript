...
const Activation = () => {
  return (
    <section className="relative h-screen bg-[url(/assets/images/activation-bg.png)] bg-cover overflow-hidden bg-center">
        <div className="w-full max-w-[1400px] mx-auto pt-[clamp(10px,5vmin,50px)] md:pt-[clamp(20px,7.778vmin,70px)] px-5 max-md:flex max-md:justify-center max-md:flex-col h-full">
            <h3 className="md:text-[clamp(28px,10.667vmin,96px)] text-[clamp(16px,10.667vmin,28px)] font-medium tracking-wide text-right">Vision and Objectives of <br />Sake Token</h3>
            <div className="flex justify-end max-md:pt-[clamp(10px,3vmin,30px)]">
                <div className="relative p-[clamp(1px,1.333vmin,12px)]">
                <div className="w-full md:w-[665px] bg-white/40 border border-black p-[clamp(16px,3.333vmin,30px)]">
