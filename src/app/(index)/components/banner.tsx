...
const Banner = () => {
  ...
  return (
    ...
    <div className="fade-up absolute left-2 top-[-78px] md:top-[-40px]  z-10 md:relative md:-mt-7 md:mr-[-28px]">
      <img
    ...
    <div className="fade-up w-full max-w-[440px] rounded-[32px] border-[3px] border-white bg-[url('/assets/images/bg-01.png')] bg-cover pb-5 md:max-w-[830px] md:rounded-[63px] md:border-[6px] md:pb-[24px] md:pl-8 ">
      <div className="flex gap-2 px-4 max-md:justify-center">
        <div className="flex-1 pt-3">
          ...
          <div className="mt-2 relative z-40 flex flex-wrap justify-center gap-2 border-t border-black pt-2 text-[14px] font-extrabold tracking-tight md:gap-3 md:text-[22px] ">
            <p className="flex gap-1 group max-md:relative">
              <span>入会金</span>
              <img
            ...
            <p className="flex gap-1 group relative">
