...
const CoinTogether = () => {
    ...
    return (
      <section ref={ref} className="relative bg-[url('/assets/images/bg-coin.png')] bg-cover pt-20 md:pt-[120px] pb-[85px] px-5">
        <div className="w-full max-w-[1326px] mx-auto">
            <div className="flex justify-between max-md:flex-col">
                ...
                <div className="flex-1 max-w-[644px] md:min-w-[500px]">
                    ...
                    <p className="fade-up md:text-[24px] text-[18px] text-center font-bold mt-6 md:mt-10 border-b border-black pb-4">お店で買い物した分だけイーサリアムがもらえる<br />COIN TOGETHER</p>

                    <p className="fade-up text-[15px] md:text-[18px] px-3 md:px-5 py-6 md:py-10">
                    日常のお買い物がイーサリアム（ETH）などのデジタル資産に変わる。<br />使えば使うほど、デジタル資産がどんどん貯まっていく。<br />それがCOIN TOGETHER。<br /><br />COIN TOGETHERでは、ポイントではなく、デジタル資産がもらえます。<br />デジタル資産の価値が上がれば、その分あなたの資産も増える可能性があります。<br />QRコードを読み取るだけで簡単にもらえちゃう！<br />すでにデジタル資産投資をしている人も、これから始めたいと思っている人も、今すぐデジタル資産を手に入れよう！
                    </p>
