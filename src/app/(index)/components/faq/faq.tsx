...
const faqData: FaqItemPropsType[] = [
  {
    id: "1",
    question: "OPEN Mapとはどのようなサービスですか？",
    answer: (
      <>
        OPEN Mapは、あなたの現在地に基づいて、地域の特典やイベント情報を一目で確認できるパーソナル地域情報マップです。カフェや店舗、観光スポットなど、日常生活をもっと便利にする情報が満載です。
      </>
    ),
  },
  {
    id: "2",
    question: "OPEN Mapは無料で利用できますか？",
    answer: (
      <>
        はい、OPEN Mapは無料で利用できます。地図上で特典や情報を探して、割引やキャンペーンなどを簡単に利用することができます。
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        OPEN Mapでは、カフェの割引クーポンや、ショップで使えるポイントアップキャンペーン、観光地でのスタンプラリー参加券など、地域の特典をたくさん見つけることができます。
      </>
    ),
  },
  {
    id: "4",
    question: "OPEN Mapはどの地域で利用できますか？",
    answer: (
      <>
        OPEN Mapは世界中で対応しており、パートナー店舗も順次拡大中です。ご利用可能なエリアは、マップ上で簡単に確認できます。
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        NFT（Non-Fungible Token）とは、デジタルアイテムや特典の所有権を証明する唯一無二のデジタル資産です。OPEN Mapでは、特定のイベントや場所でNFT特典を受け取ることができ、それを使って割引や限定サービスを受けることができます。
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
        特典やキャンペーンは、OPEN Mapで発見した後、その店舗やサービスで提示するだけで簡単に利用できます。具体的な利用方法は、各特典のNFTでご確認ください。
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Mercury Vaultは、OPEN Mapで発行するNFTを管理するデジタルウォレットで、NFTやその他のデジタル資産を安全に管理するためのツールです。このウォレットを使うことで、受け取ったNFT特典やクーポンを簡単に保管し、必要な時に利用できます。
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Mercury Vaultはアプリとしてダウンロードできます。新規ウォレットを作成して、受け取ったNFTや特典を保存し、OPEN Mapとの連携を行います。Mercury Vaultにログインすることで、いつでもNFTを確認し、特典を利用することが可能です。
      </>
    ),
  },
  {
