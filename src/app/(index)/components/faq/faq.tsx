...
const faqData: FaqItemPropsType[] = [
  ...
  },
  {
    ...
    answer: (
      <>
        提携店舗やサービスでお買い物やお支払いをすると、利用金額やキャンペーン内容に応じてイーサリアムなどのデジタル資産が還元されます。
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
      受け取ったデジタル資産はさまざまな方法でご活用いただけます。まず、そのまま保有して将来的な価値の上昇を期待することができます。また、暗号資産取引所を通じて日本円や他の暗号資産に交換したり、ステーキングや分散型金融（DeFi）サービスを利用して資産運用を行うこともできます。
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        特別に取引所の口座を開設する必要はありません。ただし、イーサリアムを取引所で売買したい場合は、その取引所での口座開設が必要となります。
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
        COIN TOGETHERは、ブロックチェーン技術を活用することで高い透明性と安全性を実現しています。METAMASKをご利用の際は、パスワードやシークレットリカバリーフレーズを外部に漏らさず、安全な環境で厳重に保管することで、より安心してご利用いただけます。
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        はい、COIN TOGETHERは暗号資産初心者の方でも簡単にご利用いただけます。アカウントの作成からイーサリアムなどのデジタル資産の受け取りまで、スムーズに行うことができます。
      </>
    ),
  },
  {
