...
export default function FaqItem({ id, question, answer }: FaqItemPropsType) {
  ...
  return (
    <div data-scroll className="ani-fade-up font-roboto space-y-2 rounded-[20px] border-[1px] border-[#F77C96] bg-white/90 p-4 md:px-8 md:pb-8 md:pt-10">
      <button
        type="button"
      ...
      >
        <div className="flex items-center gap-4 md:gap-8">
          <p className="text-[18px] text-[#F77C96] uppercase tracking-widest md:text-[32px]">
            q
          </p>
        ...
        >
          <svg className="max-md:w-8" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="24" cy="24" r="22.5" transform="rotate(-180 24 24)" stroke="#F77C96" strokeWidth="2"/>
            <path d="M28.2666 21.8667L24 26.1334L19.7333 21.8667" stroke="#F77C96" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
      </button>
