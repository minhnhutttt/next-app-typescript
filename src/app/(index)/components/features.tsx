    ...
    <section className="mt-8 bg-[linear-gradient(160deg,_#32BCFE_7.72%,_#2AB1FF_20.66%,_#28A7FE_31.36%,_#2594F7_45.44%,_#2379E7_64.01%)] [clip-path:polygon(0_0,_100%_130px,_100%_100%,_0%_100%)] px-5 overflow-hidden">
        <div className="w-full max-w-[1080px] mx-auto pt-[225px] md:pb-[180px] pb-[100px]">
            ...
            <div className="mt-[82px] space-y-[60px]">
                <div className="relative rounded-[20px] border border-[#2379E7] bg-white/20 [box-shadow:0px_0px_40px_0px_rgba(38,_64,_141,_0.10)] pt-[96px] pb-[112px] px-5">
                ...
                <div className="relative rounded-[20px] border border-[#2379E7] bg-white/20 [box-shadow:0px_0px_40px_0px_rgba(38,_64,_141,_0.10)] pt-[100px] pb-[90px] px-5">
                    <div className="absolute md:top-[-150px] top-[-50px] md:right-[-170px] right-[-60px] z-[-1]">
                        <img className="max-md:w-[160px]" src="/assets/images/feature-img-02.png" alt="" />
                    </div>
                    <div className="absolute bottom-[-60px] md:bottom-[-120px] md:left-[-180px] left-[-40px] z-[-1]">
                        <img className="max-md:w-[140px]" src="/assets/images/feature-img-03.png" alt="" />
                    </div>
                    <div className="w-full max-w-[900px] mx-auto relative">
