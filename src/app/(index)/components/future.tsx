                ...
                <div className="w-full max-w-[510px] relative">
                    <span className="absolute max-md:w-full top-5 md:top-10">
                        <svg className="max-md:w-full md:w-[511px]" viewBox="0 0 511 515" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M152.358 257.885C152.358 257.885 197.86 257.885 375.261 257.885C552.662 257.885 554.109 3.73566 375.261 3.73566C196.412 3.73566 124.005 2.5778 124.005 2.5778" stroke="#FB2C2B" strokeWidth="4"/>
                            <path d="M358.497 512.034C358.497 512.034 312.995 512.034 135.594 512.034C-41.807 512.034 -43.2543 257.885 135.594 257.885C314.442 257.885 386.85 256.727 386.85 256.727" stroke="#FB2C2B" strokeWidth="4"/>
                        </svg>
                    </span>
