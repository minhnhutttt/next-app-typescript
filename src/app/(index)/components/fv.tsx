const FV = () => {
  return (
    <section className="relative px-5 md:pt-[150px] pt-[50px] z-10 h-[450px] md:h-[750px] md:bg-[url('/assets/images/fv.png')] max-md:bg-[size:100%_auto] bg-[url('/assets/images/fv-sp.png')] bg-bottom bg-cover">
      ...
      <a data-scroll href="#" className="ani-fade-up w-[310px] h-[50px] md:h-[70px] flex items-center justify-center bg-[#000A23] mx-auto text-[#FFCD00] md:text-[26px] text-[20px] rounded-[5px]">
      WHITEPAPER
      </a>
    </section>
  );
