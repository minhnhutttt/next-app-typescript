    ...
    <section ref={ref} className="relative pr-5">
      <div className="bg-[url('/assets/images/bg-01.png')] pb-[25px] bg-[length:100%_100%] rounded-r-[45px]">
        ...
        <div className="relative w-full max-w-[1440px] mx-auto h-full pt-14 z-30">
          ...
          <div className="absolute top-0 left-[970px] z-10 pointer-events-none">
            <img
          ...
          <div className="absolute top-[460px] left-[40px] z-10 pointer-events-none">
            <img
          ...
          <div className="absolute top-[440px] left-[820px] z-10 pointer-events-none">
            <img
          ...
          <div className="flex max-lg:flex-col max-lg:items-center lg:justify-end gap-5">
            <div className="md:pl-5 max-md:px-5 lg:max-w-[720px] lg:w-full pt-6 md:pt-4">
              <div className="relative animate-[bgextendAnimeBase_1s_forwards] opacity-0 z-10">
                ...
                <div className="animate-[bgextendAnimeBase_2s_0.8s_forwards] opacity-0">
                  <p className="flex max-lg:justify-center lg:pl-[160px] max-md:mb-1">
                    <span className="bg-[linear-gradient(154deg,_#E8B85A_11.49%,_#EF38BE_83.76%)] rounded-[11px] px-3">
                      <span className="md:text-[36px] text-[24px] font-extrabold text-white leading-[1.1]">
                        S E I K A
                      </span>
                    </span>
                  </p>
                  <h1 className="md:text-[60px] lg:text-[62px] xl:text-[80px] text-[44px] font-extrabold leading-[1.1] space-y-1">
                    <p>真の成果を<span className="u-text-gradient-or">AI</span>と<br />狙い撃つ!!</p>
                    <p><span className="bg-[linear-gradient(154deg,_#E8B85A_11.49%,_#EF38BE_83.76%)] rounded-[11px] px-3 text-white inline-block ">SEIKAI</span> 広告<br />エージェント</p>
                  </h1>
                </div>
              </div>
            ...
            <div ref={containerRef} className="fade-up pt-10 md:pt-10">
              ...
              <div className="fade-up flex justify-center mt-11 relative z-30 max-md:px-5">
            <img
