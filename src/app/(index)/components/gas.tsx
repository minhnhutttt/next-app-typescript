...
const Gas = () => {
  ...
  return (
    <section ref={ref} className="bg-[linear-gradient(180deg,_#120E18_-4.01%,_#3D14B0_74.98%)] overflow-hidden md:[clip-path:polygon(0_0,_100%_0,_100%_calc(100%-160px),_0%_100%)] [clip-path:polygon(0_0,_100%_0,_100%_calc(100%-80px),_0%_100%)]">
        <div className="bg-[url('/assets/images/gas-bg.png')] bg-[length:100%_auto] bg-no-repeat bg-bottom px-5">
            <div className="md:pt-[175px] pt-[115px] md:pb-[160px] pb-[160px]">
                <div className="fade-up relative flex justify-center items-center">
                ...
                <div className="flex gap-5 md:gap-16 md:mt-[46px] mt-8 max-md:items-center max-md:flex-col w-full md:max-w-[1060px] max-w-[440px] mx-auto">
                    <figure className="fade-up max-md:w-full max-lg:w-1/3">
                        <img className="max-md:max-w-[300px]" src="/assets/images/zero-gas-fees.png" alt="" />
                    </figure>
                    <div className="fade-up flex-1 md:pt-10">
