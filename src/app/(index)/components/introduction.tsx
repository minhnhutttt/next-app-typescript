...
const Introduction = () => {
  ...
  return <section ref={ref} className="px-5 md:pt-[52px]">
    ...
    <div className="md:py-[60px] py-10 font-bold leading-[1.2]">
        ...
        <p className="text-center md:text-[42px] text-[24px]">公認パートナー</p>
        <p className="text-center md:text-[32px] text-[20px] md:mt-7 mt-5 tracking-widest">
        所属ライバーが<br />累計3000人を突破 !!
        </p>
        <p className="text-center md:text-[32px] text-[20px] md:mt-14 mt-9 tracking-widest">
        ライバーになりたい方<br />随時募集中 !
        </p>
    </div>
    <div className="mt-4">
        <Title>Good Fellows とは</Title>
        <p className="w-full max-w-[425px] mx-auto md:text-[18px] text-[15px] py-5">
