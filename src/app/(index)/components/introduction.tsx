...
const Introduction = () => {
  return (
    <section className="relative h-screen bg-[url(/assets/images/intro-bg.png)] bg-cover overflow-hidden bg-center">
      <span className="ani-mix-blend absolute h-full md:w-[28%] w-[36%] bg-[#BF2A2A] mix-blend-overlay"></span>
        ...
        <div className="w-full max-w-[1400px] mx-auto pt-[100px] dt:pt-[70px] px-5 max-md:flex max-md:flex-col h-full">
            <h3 className="ani-text leading-loose text-[36px] md:text-[80px] lg:text-[96px] font-medium tracking-wide">What is Sake Token?</h3>
            <p className="ani-content max-w-[730px] md:text-[18px] font-medium md:px-10 [text-shadow:0_0_5px_#fff]">
