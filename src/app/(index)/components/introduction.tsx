        ...
        <div className="md:mt-[70px] mt-10">
          <div className="max-lg:px-5">
            <h3 className="fade-up flex md:text-[42px] text-[24px] font-black leading-[1.3] relative tracking-[-0.018em]">
                <span className="absolute md:left-[-40px] left-[-28px] top-1 md:top-2.5"><img className="max-md:w-6" src="/assets/images/ic-title.svg" alt="" /></span>LP訪問者の99％はコンバージョンせず<UnderlineText>に離脱します。</UnderlineText></h3>
