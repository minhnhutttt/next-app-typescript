        ...
        <div className="w-full max-w-[1234px] mx-auto mt-8 md:mt-11">
            ...
            <div className="w-full max-w-[754px] mx-auto md:rounded-[64px] rounded-[32px] relative overflow-hidden">
                ...
                <div className="relative text-white font-bold py-3 px-6 md:px-10">
                    <h4 className="text-center md:text-[27px] text-[21px]">当社のeラーニングが貴社に最適な3つの理由</h4>
                </div>
            </div>
            <p className="text-center md:text-[20px] text-[16px] font-bold py-4 max-w-[540px] w-full mx-auto">
                私たちは「低コスト」「短期間」「実用的で最新」の <br className="max-md:hidden" />
                プログラムをeラーニングとして提供いたします。
            </p>
            <div className="w-full max-w-[1166px] mx-auto pt-7 mt-3 relative">
                <span className="absolute size-[545px] top-10 md:top-0 left-1/2 -translate-x-1/2">
                    <img src="/assets/images/circle.png" alt="" />
                </span>
                <div className=" lg:space-y-20 space-y-10">
                    <div className="flex items-start max-md:flex-col max-md:items-center justify-center gap-5 md:gap-9 relative">
                    ...
                    <div className="flex items-start max-md:flex-col max-md:items-center gap-10 lg:gap-20 relative">
                        <div className="w-full md:w-1/2 max-w-[545px] rounded-[20px] border-[3px] border-[#FFBE5E] bg-white p-3">
                            <div className="flex items-center gap-2 border-b border-[#A8A7A7] pb-2.5">
            ...
            <div className="md:mt-10 mt-7 scroll-mt-24" id="contact">
