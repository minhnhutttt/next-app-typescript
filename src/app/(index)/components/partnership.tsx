      ...
      <div className="container">
        <div className="mx-auto max-w-[1200px] rounded-[12px] bg-[#eee] p-[6%]">
          ...
          <div className="mb-[24px]">
            株式会社
            Yumeaciは、WEB制作・システム開発、アパレル製品やノベルティグッズの企画を通じて、常に最新のデジタル技術とクリエイティブなトレンドを追求し、それをお客様のビジネスに最大限に活かしています。また、カスタマイズされたシステム開発ソリューションや独自のアパレル・ノベルティグッズ企画により、ブランド価値の向上とビジネスの成長を力強く支援します。
          </div>
          <a
