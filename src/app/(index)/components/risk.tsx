...
const Item = ({number, title, children, rect, color}: {number:string, title: string, children: ReactNode, rect?: string, color: string}) => (
  <div className={`${rect} fade-up max-md:flex-[0_0_70vw] size-[70vw] md:size-[29.861vw] dt:size-[430px] rounded-full flex flex-col items-center border-[1.042vw] dt:border-[15px] bg-white text-center p-[0.556vw] dt:p-2 [box-shadow:0px_5px_10px_0px_rgba(0,_0,_0,_0.20)]`} style={{borderColor: color}}>
    <div className="w-full md:max-w-[19.444vw] max-w-[55vw] dt:max-w-[280px]">
      ...
      <h3 className="dt:text-[20px] text-[4vw] md:text-[1.389vw] my-[1.111vw] dt:my-4 font-bold text-[#DF0F47]">{title}</h3>
          ...
          if (sliderContainer) {
            gsap.to(panels, {
              ...
              scrollTrigger: {
                ...
                end: () => '+=' + sliderContainer.offsetWidth / 2,
              },
            })
          }
      }, sliderRef)
  ...
  return (
    <section ref={containerRef} className="relative overflow-hidden">
      ...
      <div className="w-full max-w-[1360px] mx-auto md:mb-[70px] mb-10 relative">
        ...
        <div className="relative w-full dt:w-[1330px] mx-auto pt-12 md:pt-20 overflow-auto no-scrollbar">
          <div className="relative w-full md:h-full max-md:hidden">
            <div className="flex-[0_0_50vw] md:absolute flex flex-col justify-center max-md:mx-auto size-[50vw] md:size-[22.639vw] dt:size-[326px] rounded-full bg-white border-[1.389vw] dt:border-[20px] border-[#D9D9D9] text-center p-[1.111vw] dt:p-4 shadow-md md:top-[20.833vw] dt:top-[260px] left-1/2 transform md:-translate-x-1/2 mt-[6.25vw]">
              ...
              <p className="dt:text-[16px] text-[3vw] md:text-[1.111vw] mt-[10px] px-[1.944vw] dt:px-7 text-left">
                もし、福利厚生が不十分な場合、<span className="text-[#DF0F47]">５種類リスク</span>が生じる可能性があります。
              </p>
            </div>
            ...
            <Item number="01" title="優秀な人材が流出するリスク" color="#73E3DC">
              優秀な従業員が、より福利厚生の充実した競合他社へと流出する可能性が高まります。<span className="font-extrabold  text-[#DF0F47]">従業員の定着率が下がれば、採用コストが増加</span>し、チームの一体感も損なわれます。
            </Item>
            <Item number="02" title="従業員のモチベーション低下"  color="#5DF340">
            福利厚生が不十分だと、従業員の満足度が低下し、仕事に対するモチベーションや生産性も下がる傾向があります。これは<span className="font-extrabold  text-[#DF0F47]">企業全体の業績にも悪影響</span>を与えます。
            </Item>
            </div>
            ...
            競合他社が福利厚生の充実を図っている中、自社だけがその取り組みを怠ると、市場での競争力が低下します。<span className="font-extrabold  text-[#DF0F47]">福利厚生が優れた企業は、より優秀な人材を集め、強力な組織を築くことができます。</span>
            </Item>
            <Item number="04" title="メンタルヘルス問題の増加" color="#FFC300" rect="md:mt-[18.75vw] dt:mt-[270px]">
            福利厚生が不足していると、従業員の健康管理が不十分になり、メンタルヘルスの問題やストレスによる長期休暇が増加するリスクがあります。これは、<span className="font-extrabold  text-[#DF0F47]">企業の生産性を低下させる大きな要因です。</span>
            </Item>
            <Item number="03" title="企業イメージの低下"  color="#F97E3C">
            企業が従業員の福利に投資しないことは、外部から「従業員を大切にしない企業」という印象を与える可能性があり、<span className="font-extrabold  text-[#DF0F47]">求職者や取引先、顧客に対してもマイナスの影響を与えます。</span>
            </Item>
            </div>
          </div>
          <div ref={sliderRef} className="md:hidden flex items-center ">
            <div className="panel flex-[0_0_100vw] flex justify-center">
              <div className="flex-[0_0_70vw] md:absolute flex flex-col justify-center max-md:mx-auto size-[70vw] md:size-[22.639vw] dt:size-[326px] rounded-full bg-white border-[1.389vw] dt:border-[20px] border-[#D9D9D9] text-center p-[1.111vw] dt:p-4 shadow-md md:top-[20.833vw] dt:top-[260px] left-1/2 transform md:-translate-x-1/2 mt-[6.25vw]">
                <p className="dt:text-[32px] text-[4vw] md:text-[2.222vw]">リスクについて</p>
                <p className="dt:text-[16px] text-[3vw] md:text-[1.111vw] mt-[10px] px-[1.944vw] dt:px-7 text-left">
                  もし、福利厚生が不十分な場合、<span className="text-[#DF0F47]">５種類リスク</span>が生じる可能性があります。
                </p>
      ...
      <div className="px-5">
        ...
        <span className="font-extrabold text-[#DF0F47]">福利厚生の充実は単なる付加価値ではなく、企業の成長と持続可能性に直結する重要な要素です。</span><br />
