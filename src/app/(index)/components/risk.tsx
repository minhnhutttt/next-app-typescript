  ...
  return (
    <section ref={ref} className="relative">
      ...
      <div className="w-full max-w-[1360px] mx-auto md:mb-[70px] mb-10 relative">
        ...
        <div className="relative w-full dt:w-[1330px] mx-auto mt-12 md:mt-20 overflow-auto no-scrollbar">
          <div className="relative w-full md:h-full max-md:hidden">
            ...
            <Item number="01" title="優秀な人材が流出するリスク" color="#73E3DC">
              優秀な従業員が、より福利厚生の充実した競合他社へと流出する可能性が高まります。<span className="font-extrabold">従業員の定着率が下がれば、採用コストが増加</span>し、チームの一体感も損なわれます。
            </Item>
            <Item number="02" title="従業員のモチベーション低下"  color="#5DF340">
            福利厚生が不十分だと、従業員の満足度が低下し、仕事に対するモチベーションや生産性も下がる傾向があります。これは<span className="font-extrabold">企業全体の業績にも悪影響</span>を与えます。
            </Item>
            </div>
            ...
            競合他社が福利厚生の充実を図っている中、自社だけがその取り組みを怠ると、市場での競争力が低下します。<span className="font-extrabold">福利厚生が優れた企業は、より優秀な人材を集め、強力な組織を築くことができます。</span>
            </Item>
            <Item number="04" title="メンタルヘルス問題の増加" color="#FFC300" rect="md:mt-[18.75vw] dt:mt-[270px]">
            福利厚生が不足していると、従業員の健康管理が不十分になり、メンタルヘルスの問題やストレスによる長期休暇が増加するリスクがあります。これは、<span className="font-extrabold">企業の生産性を低下させる大きな要因です。</span>
            </Item>
            <Item number="03" title="企業イメージの低下"  color="#F97E3C">
            企業が従業員の福利に投資しないことは、外部から「従業員を大切にしない企業」という印象を与える可能性があり、<span className="font-extrabold">求職者や取引先、顧客に対してもマイナスの影響を与えます。</span>
            </Item>
            </div>
          </div>
          <div ref={sliderRef} className="md:hidden flex items-center h-screen">
      ...
      <div className="px-5">
        ...
        <span className="font-extrabold">福利厚生の充実は単なる付加価値ではなく、企業の成長と持続可能性に直結する重要な要素です。</span><br />
