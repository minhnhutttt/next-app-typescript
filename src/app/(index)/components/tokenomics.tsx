  ...
  return (
    <section ref={ref} id="tokenomics" className="relative px-5 md:py-[160px] py-[100px]">
      <div className="w-full max-w-[1304px] mx-auto">
            <h4 className="md:text-[80px] text-[40px] text-center font-bold leading-none">Tokenomics</h4>
            <p className="text-center md:mt-[30px] mt-5 md:text-[20px] text-[16px] font-bold">Total number of issues: 1 billion SANTA</p>
            <div className="flex max-lg:flex-wrap justify-center xl:gap-[104px] gap-10 md:mt-[60px] mt-10">
                <div className="md:w-[600px] w-full md:rounded-[80px] rounded-[40px] bg-white md:p-[60px] p-8 [box-shadow:0px_0px_60px_0px_rgba(0,_0,_0,_0.10)]">
