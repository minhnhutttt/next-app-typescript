...
const list = [
  {
    ...
    content: (
      <>
        「今日のランチはどこにしよう？」そんな時におすすめしたいのが、META Earthで見つけた地元の人気カフェ。<br />特典付きのクーポンが使えるのでちょっとお得に美味しいランチを楽しめます。新しいお気に入りのカフェを見つけてみては？
      </>
    ),
  },
  {
    ...
    content: (
      <>
        急に必要になった薬や日用品、どこで買えばいいか迷ったらMETA Earthでチェック！<br />
        近くの薬局で、ポイントアップのキャンペーンが開催中。<br />
        日常のお買い物がもっとお得になりますよ。
      </>
    ),
  },
  {
    ...
    content: (
      <>
        家族や友達と過ごす週末、どこに行こうか迷ったら、近くのアミューズメントパークで楽しんでみては？<br />
        META Earthを使えば、特別割引のNFTも手に入るので、遊びながらお得に過ごせます。
      </>
    ),
  },
  {
    ...
    content: (
      <>
        街を歩いていたらMETA Earthに期間限定のポップアップストアが表示されました！ 普段は手に入らないアイテムやお得なキャンペーンが目白押し！
        <br />
  ...
  },
  {
    ...
    content: (
      <>
        髪を切りたいなと思ったら、META Earthで近くの美容院を探してみてください！ 初回限定クーポン付きの美容院がすぐに見つかり、気軽に予約もできちゃいます。 新しい自分に生まれ変わるチャンスかも？
      </>
    ),
  },
  {
    ...
    content: (
      <>
        季節の変わり目に合わせて、ネイルやエステを楽しんでみては？<br />META Earthで開けば、今ならお得なクーポンが付いているサロンもありますよ。 リフレッシュして、新しい季節を迎えよう！
      </>
    ),
  },
  {
    ...
    content: (
      <>
        健康を意識し始めたら、まずはフィットネスジムやヨガスタジオをMETA Earthで探してみよう！<br />初回体験クーポン付きのスタジオが見つかれば、お試しで気軽に運動をスタートできます！
      </>
    ),
  },
  {
    ...
    content: (
      <>
        衣替えの季節、クリーニングが必要な衣類をどうしよう？<br />そんな時はMETA Earthで近くのクリーニング店をチェック。<br />今だけ割引キャンペーンを実施している店舗も簡単に見つかります！
      </>
    ),
  },
  {
    ...
    content: (
      <>
        家に眠っている不用品、どうにかしたい！<br />META Earthを開けば買取価格アップのキャンペーン中のお店も見つかって、お得に断捨離できるチャンスです！
      </>
    ),
  },
  {
    ...
    content: (
      <>
        「車の点検が必要だけど、どこに持っていけばいいか迷った時にはMETA Earthが便利！<br />オイル交換工賃無料等のサービスがある整備工場を簡単に見つけて、すぐに予約してみましょう。
      </>
    ),
  },
  {
    ...
    content: (
      <>
        地元をもっと楽しむために、META Earthでスタンプラリーに参加しよう！<br />名所を巡りながらスタンプを集めて、限定NFTも手に入れることができます。 家族や友人と一緒に、楽しい冒険を楽しみましょう！
      </>
    ),
  },
  {
