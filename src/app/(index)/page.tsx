          ...
          <div className="flex max-md:items-center justify-between max-md:mt-10 -mt-[clamp(1px,9vmin,90px)] relative max-md:flex-col">
            <div className="relative flex md:flex-col items-start max-md:justify-between max-md:w-full flex-1">
              <div className="ani-image max-md:-left-5 max-md:top-[-10vw] max-md:w-[36vw] opacity-0 inline-flex relative z-20">
                ...
                <img className="md:h-[clamp(1px,31.8vmin,319px)] dt:h-[clamp(1px,40vmin,420px)]" src="/assets/images/img-01.png" alt="" />
              ...
              <div className="ani-image max-md:absolute max-md:left-[30%] max-md:top-[20%] max-md:w-[36vw] opacity-0 inline-flex animate-[fuwafuwa_3s_ease-in-out_infinite_alternate] [animation-delay:0.1s] -mt-[clamp(1px,2vmin,20px)] dt:-mt-[clamp(1px,10vmin,100px)] lg:ml-5 dt:ml-[clamp(1px,24vmin,240px)] relative z-10">
                <img className="md:h-[clamp(1px,30.6vmin,306px)] dt:h-[clamp(1px,38vmin,380px)]" src="/assets/images/img-02.png" alt="" />
              </div>
              <div className="ani-image max-md:w-[36vw] max-md:-right-4 opacity-0 inline-flex animate-[fuwafuwa_3s_ease-in-out_infinite_alternate] [animation-delay:0.5s] relative -mt-5 dt:-mt-[clamp(1px,15vmin,150px)] lg:-mt-[clamp(1px,5vmin,50px)] lg:ml-32 dt:ml-2 z-30">
            ...
            <div className="flex md:flex-col items-start md:items-end dt:-mt-32 flex-1 relative">
              <div className="flex flex-col items-end">
                <div className="ani-image opacity-0 max-md:w-[36vw] inline-flex animate-[fuwafuwa_3s_ease-in-out_infinite_alternate] [animation-delay:0.3s] lg:mr-20">
                  <img className="md:h-[clamp(1px,35.9vmin,300px)] dt:h-[clamp(1px,42vmin,420px)]" src="/assets/images/img-04.png" alt="" />
                </div>
