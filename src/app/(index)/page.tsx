  ...
  return (
    <main ref={ref} className="">
        ...
        <div className="fade-up sticky bottom-6 md:bottom-10 inset-x-0 flex justify-center z-50">
            <a href="/assets/pdf/GATE Coin (UGTC) Whitepaper.pdf" target="_blank" className="shiny-button w-[240px] h-14 md:w-[280px] md:h-[70px] flex items-center justify-center md:text-[24px] text-[18px] text-center bg-[radial-gradient(200.36%_122.36%_at_9.55%_0.65%,_#000_0%,_rgba(0,_0,_0,_0.27)_100%)] tracking-widest">WHITEPAPER</a>
        </div>
