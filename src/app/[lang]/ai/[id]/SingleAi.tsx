              ...
              <div className="px-3 dark:text-white font-light">
                ...
                <div className="flex justify-start mt-12">
                  <a
                    ...
                    className="text-[24px] font-bold text-black bg-[#F8D0B2] px-12 py-2 rounded-full duration-150 hover:opacity-75 border border-[#C6C6C6] uppercase"
                  >
                    contact
                  </a>
                </div>
                ...
                <div className="overflow-auto h-[calc(100vh-100px)]">
                  <figure className="pb-7">
                    ...
                    <img
                      ...
                      alt="Annotation icon dark"
                    />
                  </figure>
                  {article.annotations.map((annotation, index) => (
                    <div
                      key={index}
                      className="w-[272px] mx-auto dark:text-white bg-white/70 dark:bg-white/30 border border-[#A06778]/[0.7] dark:border-[#996894]/[0.7] p-2.5 mb-4"
                    >
