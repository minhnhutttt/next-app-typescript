import { dataBlockChain, getArticleByIdAndLang2 } from '@/app/data/data';
...
export async function generateStaticParams() {
  ...
  for (const article of dataBlockChain) {
...
export default function BlockchainArticlePage({ params }: { params: { lang: string, id: string } }) {
  ...
  const article = getArticleByIdAndLang2(dataBlockChain, id, lang);
