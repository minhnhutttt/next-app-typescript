...
const business = [
  ...
  },
  {
    ...
    description:
      (<>Enabling content creation through financing, production support, <br />and creative development tailored to both local and global audience preferences</>),
  },
  {
    id: 4,
    title: "Market Access",
      ...
      <div>
          ...
          <div className="mb-[210px]">
            ...
            <div className="w-full relative pb-20 md:mt-[-60px] mt-12">
                    ...
                    >
                      {business.map((item) => (
                        <SwiperSlide key={item.id} className="md:!w-[564px] md:!h-[472px] !h-[350px] bg-[#EEEEEE] !w-[330px] mx-2.5 rounded-[30px]">
                          <div className="relative p-5 md:p-[30px]">
                            <div className="md:w-[130px] md:h-[167px] w-16 h-[90px] flex justify-between relative">
                              <span className="md:text-[120px] text-[50px] leading-none font-medium">{item.id}</span>
                              <span className="w-px h-[80px] md:h-[160px] absolute bg-[#111] rotate-[30deg] md:left-10 left-4 top-0 origin-bottom"></span>
                              <span className="md:text-[64px] text-[32px] leading-none font-medium flex items-end pb-3">{business.length}</span>
                            </div>
                            <div className="md:py-10 py-5 px-2 md:px-[18px]">
                              <p className="text-center md:text-[24px] font-semibold text-[20px]">{item.title}</p>
                              <p className="md:text-[18px] text-[15px] md:mt-[30px] mt-[20px]">{item.description}</p>
                            </div>
                          </div>
                        </SwiperSlide>
                      ))}
