        ...
        <div className="container">
          <div>
            ...
            <div className="mb-[32px] border-b border-solid border-b-[rgba(172,172,172,0.3)] pb-[32px] text-[24px] leading-[1.6] max-md:text-[16px]">
              TECHNO
              LLCは、テクノロジーを駆使し、お客様のビジネスの成長と革新をサポートするグローバルなパートナーです。私たちは、調査、代行、デジタルマーケティングの3つの領域において、豊富な経験と高い専門性を持つプロフェッショナルチームを擁しています。お客様のニーズに合わせたカスタマイズされたソリューションを提供し、ビジネスの効率化と最適化を実現します。AIをはじめとして、常に最新のテクノロジーとトレンドを取り入れ、お客様の競争力強化に貢献します。TECHNO
              LLCは、お客様との長期的なパートナーシップを大切にし、共に成長することを目指しています。
            </div>
            <div className="grid grid-cols-3 gap-[32px] max-md:grid-cols-1">
              <div>
                ...
                <div className="text-[18px] leading-[1.6] max-md:text-[16px]">
                  ...
                  <br />
                  <br />
                  私たちは、お客様のビジネスに必要な情報を収集し、専門的な視点から分析します。市場動向、競合他社、顧客ニーズなど、あらゆる角度からデータを収集し、意思決定に役立つ洞察を提供します。
                </div>
              </div>
              <div>
                <div className="text-[calc(21px_+_2vw)] uppercase">
              ...
              <div>
                ...
                <div className="text-[18px] leading-[1.6] max-md:text-[16px]">
                  最新のデジタルマーケティング戦略で競争力を強化
                  <br />
                  <br />
                  私たちは、デジタル領域における最新のトレンドと技術を常に取り入れ、お客様のビジネスに活用します。データ分析に基づいたターゲティング、クリエイティブな広告制作、最適なチャネル選択など、効果的なデジタルマーケティング戦略を立案・実行します。
                </div>
              </div>
            </div>
          </div>
