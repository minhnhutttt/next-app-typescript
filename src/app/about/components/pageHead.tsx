  ...
  return (
    <section ref={ref} className="relative pt-[130px] z-10">
      <div className="w-full mx-auto overflow-hidden">
        <div className="px-7 md:px-[60px] md:text-[64px] text-[32px] font-medium tracking-wide">
            DIVER's Philosophy
        </div>
        <div className="h-[100px] md:h-[156px] bg-[url('/assets/images/about-title-line.png')] bg-[lenth:100%_100%] flex items-center">
        ...
        <div className="px-7 md:px-[60px] md:text-[20px] text-[16px] py-5">
