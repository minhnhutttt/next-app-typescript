...
export default function AISingle() {
    ...
    <main>
      <div ref={ref} className="relative">
        <div className="flex">
            <div className="fade-up flex-1 pb-[324px] pt-6 px-4">
                ...
                <div className="px-3">
                    ...
                    <div className="flex justify-end py-4">
                        <TitleAI rect="md:h-[15px] h-[12px]" />
                    </div>
                    <div className="bg-white dark:bg-white/40 dark:text-white md:text-[17px] text-[15px] p-4 md:p-6 leading-[1.8]">
                    <span className="font-bold underline xl:hidden">イーロン・マスク</span><span className="font-bold underline max-xl:hidden">イーロン・マスク</span>が4月28日に中国を訪問し、李強首相と会談した。その成果にはバイドゥ（百度）との提携拡大などが含まれるとされているが、中国メーカーの技術の進展が著しいなかテスラが厳しい競争を強いられることには変わりないだろう。
                    </div>
            ...
            <div className="max-xl:hidden w-[295px] bg-[#FFE1CB] dark:bg-[#90524A]/[0.68] border-l border-[#A06778] dark:border-white flex flex-col justify-between">
                <div className="fade-up px-3 pt-6 sticky top-0">
                    ...
                    <div className="w-[272px] mx-auto dark:text-white bg-white/70 dark:bg-white/30 border border-[#FF9040]/[0.7] dark:border-[#8E6772]/[0.7] p-2.5">
            ...
            <div className="w-[300px] md:w-[500px] mx-auto dark:text-white bg-white dark:bg-[#666666] border border-[#FF9040]/[0.7] dark:border-[#8E6772]/[0.7] p-2.5">
