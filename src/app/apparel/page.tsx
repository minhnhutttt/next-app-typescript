...
const DataFaq = [
  {
    id: '1',
    title: 'アパレルやノベルティグッズの制作期間はどのくらいかかりますか？',
    content: (
      <>
  ...
  },
  {
    ...
    content: (
      <>
        はい、量産前にサンプルをご提供いたします。サンプルを確認いただいた上で、デザインや品質に関してフィードバックをいただき、必要に応じて修正を行います。サンプルの確認により、最終製品がクライアントの期待に応えるものであることを保証します。
      </>
    ),
  },
]
