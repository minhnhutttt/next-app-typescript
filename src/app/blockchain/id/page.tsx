            ...
            <div className="px-3">
              ...
              <div className="px-3 dark:text-white font-light">
                <div className="md:text-[19px] text-[15px] md:pt-10 pt-7 leading-[1.9]">
                  ...
                  <br />
                  <br />
                  <ol className="list-inside list-decimal relative">
                    <li>ビットコインは速い</li>
                    <li className="relative">
                      ビットコインの
                      <span className="inline-block group font-bold border-b-[2px] border-dashed border-[#F8D0B2] leading-none">
                        ボラティリティ
                        <span className="group-hover:opacity-100 opacity-0 absolute top-0 left-0 w-[300px] md:w-[500px] mx-auto dark:text-white bg-white dark:bg-[#666666] border border-[#A06778]/[0.7] dark:border-[#996894]/[0.7] p-2.5">
                        <span className="fixed inset-0 pointer-events-none bg-black/50"></span>
                          <span className="md:text-[17px] text-[15px] font-semibold border-b border-[#E01652] dark:border-white py-1 block relative">
                            ボラティリティ
                          </span>
                          <span className="md:text-[16px] text-[14px] py-2.5 block leading-normal relative">
                ...
                <div className="flex justify-start mt-12">
                  <a
                    ...
                    className="text-[24px] font-bold  text-[black] bg-[#F8D0B2] px-12 py-2 rounded-full duration-150 hover:opacity-75 border border-[#C6C6C6]"
                  >
                    CONTACT
                  </a>
                </div>
