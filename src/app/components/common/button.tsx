...
export default function Button({ href, children }: ButtonPropsType) {
  ...
  return (
    <div ref={animateRefs} className="md:h-[64px] h-[50px] px-8 md:px-[60px] flex items-center justify-center relative overflow-hidden rounded-[40px] md:text-[18px] text-[16px] opacity-0 hover:tracking-widest duration-300 origin-center">
