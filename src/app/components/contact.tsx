...
const Contact = () => {
  ...
  return (
    ...
    >
      <div className="w-full md:max-w-[1100px] max-w-[475px] mx-auto flex max-md:flex-col items-center justify-center gap-10">
        <div className="flex-1">
            <Title left>
            Join EXO DAO
            </Title>
            <p className="fade-up font-roboto text-[16px] mt-6">Become a member and be part of a revolutionary community.</p>
            <p className="flex gap-2 text-[16px] font-roboto items-center mt-2">
                <figure>
        ...
        <div className="flex-1 md:space-y-10 space-y-7 max-md:mt-10">
            <form className="space-y-10">
                <div>
                    <label htmlFor="name" className="text-[14px] font-medium mb-1">Full Name</label>
                ...
                <div>
                    <label htmlFor="email" className="text-[14px] font-medium mb-1">Email</label>
                    <div className="w-full">
                ...
                <div>
                    <label htmlFor="country" className="text-[14px] font-medium mb-1">Country</label>
                    <div className="w-full">
                ...
                <div className="">
                <button className="w-[180px] h-12 flex items-center justify-center px-[22px] py-4 gap-2 rounded-xl bg-[#00F4AE] text-[16px] font-semibold">
