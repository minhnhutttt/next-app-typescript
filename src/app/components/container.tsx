    ...
    return (
        ...
        <div className="flex items-start">
          ...
          <div className="relative -top-2">
            <div className="flex sticky top-10 justify-center mx-3 max-md:hidden z-10 h-[44px] overflow-hidden rounded-full">
              <Anime />
            </div>
          </div>
          
          <div className="flex flex-1 relative">
            <div className="absolute h-full w-px bg-white/40 left-[-34px] max-md:hidden"></div>
            <div className="w-full">
              <div className="rounded-[23px] w-full md:min-h-[45px] min-h-[38px] flex items-center border border-[#B5B5B5]/[0.85] bg-[linear-gradient(90deg,_#0B0B0B_28.57%,_rgba(11,_11,_11,_0.46)_50%)] px-5 md:px-[38px] text-[15px] md:text-[23px] font-bold text-[#FF9016]/70">{title}</div>
            ...
            <div className="absolute h-full w-px bg-white/40 right-[-34px] max-md:hidden"></div>
          </div>
