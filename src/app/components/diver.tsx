...
const Articles = [
  {
    ...
    generally:
      "OCRによる読み取りのため、誤登録のリスクがあります。",
    diver: "デジタルデータ（NFTのメタデータ）をそのまま受け渡すため、常に正確な情報にアクセスできます。",
  },
  {
    number: "2",
    type: "Immediacy",
    ...
    diver: "アプリ上での簡単な操作により、その場ですぐに名刺交換が完了。交換相手の連絡先をスピーディーに活用可能です。",
  },
  {
    number: "3",
    type: "Expandability",
    ...
    diver: "テキスト、画像、動画など様々な情報を盛り込むことができ自己紹介やポートフォリオの共有も可能。また、リンク先情報を随時更新することで常に最新の情報を相手に提供できます。",
  },
  {
    number: "4",
    type: "Authenticity",
    ...
    diver: "ブロックチェーン上で発行者が証明され、なりすましや偽造が極めて困難。騙されたり、悪用されたりすることを防止できます。",
  },
  {
    number: "5",
    ...
    generally: "紙の名刺をスキャンするだけなので、デザイン性は元の名刺に依存します。",
    diver: "デジタルデザインの自由度が高く、自分らしさを表現できます。画像や動画などのメディア素材を用意して、インパクトのある名刺を制作してください。",
  },
  {
    number: "6",
    ...
    diver: <span className="md:text-[16px] text-[12px]">情報はブロックチェーンで制御され、特別な暗号化により非公開NFTとして扱われます。第三者からの盗み見リスクがなく、情報共有を防ぎます。独自の転送制御技術で、NFT名刺の転送は1回のみに制限され、無断転送や拡散を防ぎ高度な情報保護を実現します。</span>,
  },
  {
    number: "7",
    type: "Security",
    ...
    generally:
      ...
      diver: <span className="md:text-[16px] text-[12px]">ブロックチェーン技術による高度な暗号化とアプリ「DIVER Biz」独自の秘匿化技術の組み合わせにより、業界最高水準のセキュリティを実現。安心して名刺情報を管理・交換できます。</span>,
  },
  {
    number: "8",
    type: "Sustainability",
    ...
    diver: "紙の名刺を使用せずにデジタルで完結するため、森林資源の保護や廃棄物の削減に役立ちます。SDGsの目標達成を支援し、環境に優しいビジネスを促進できます。",
  },
  {
    number: "9",
    type: "Impression",
    ...
    generally:
      ...
      diver: <span className="md:text-[16px] text-[12px]">NFT名刺採用はDX <span className="md:text-[13px] text-[11px]">(デジタルトランスフォーメーション)</span>への積極姿勢を示し、革新性とテクノロジーへの理解を強調します。これにより、信頼を獲得し、ビジネスパートナーとの関係を強化できます。</span>,
  },
];
...
const Diver = () => {
  ...
  return (
    <section className="bg-[#00FFD1] pt-[60px] md:pt-[120px]">
        ...
        <div className="relative">
          <div className="absolute inset-0 z-10 bg-[linear-gradient(0deg,_rgba(0,_0,_0,_0.80)_0%,_rgba(0,_0,_0,_0.80)_100%)] flex items-center justify-center px-5">
            <div className="relative w-full max-w-[583px] mx-auto text-white md:text-[18px] text-[14px] leading-[1.9]">
              ...
              一般的な名刺管理アプリの課題は、NFT名刺&アプリ「DIVER Biz」で解決できます。<br />NFT名刺&アプリ「DIVER Biz」なら、あらゆる面で優れた名刺管理体験を提供します。<br />今すぐフォームからNFT名刺を制作して、アプリ「DIVER Biz」を介した次世代の名刺管理とコミュニケーションの革新を体験してください！
              </p>
      ...
      <Modal isOpen={modalOpen} onClose={() => setModalOpen(false)} rect="bg-[#00FFD1]">
