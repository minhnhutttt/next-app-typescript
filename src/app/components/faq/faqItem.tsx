...
export default function FaqItem({ id, question, answer }: FaqItemPropsType) {
  ...
  return (
    <div data-scroll className="ani-fade-up space-y-2 rounded-[20px] border-[3px] border-[#2639A6] bg-white/90 p-4 md:px-8 md:pb-8 md:pt-10">
      <button
        type="button"
...
<circle cx="24" cy="24" r="22.5" transform="rotate(-180 24 24)" stroke="#2639A6" strokeWidth="3"/>
<path d="M28.2666 21.8667L24 26.1334L19.7333 21.8667" stroke="#2639A6" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
        </div>
      </button>
