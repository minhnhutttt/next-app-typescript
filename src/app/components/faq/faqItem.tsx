...
export default function FaqItem({ id, question, answer }: FaqItemPropsType) {
  ...
  return (
    <div data-scroll className="ani-fade-up space-y-2 rounded-[20px] border-[1px] border-[#FA3D51] bg-white/90 p-4 md:px-8 md:pb-8 md:pt-10">
      <button
        type="button"
      ...
      >
        <div className="flex items-center gap-4 md:gap-8">
          <p className="text-[18px] text-[#FA3D51] uppercase tracking-widest md:text-[32px]">
            q
          </p>
