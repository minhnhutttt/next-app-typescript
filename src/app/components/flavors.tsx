...
const data = [
    {
      ...
      from: "千葉産",
      name: "Chiba",
      image: "/assets/images/img-flavors-card-chiba.png",
      body: (
        <>
          独特の香りと風味を持っています。
          <br />
    ...
    },
    {
        ...
        from: "青梅産",
        name: "ome",
        image: "/assets/images/img-flavors-card-ome.png",
        body: (
        <>
    ...
    },
    {
        id: "03",
              from: "和歌山産",
              name: "Wakayama",
              image: "/assets/images/img-flavors-card-wakayama.png",
              body: (
                <>
  ...
  export default function Flavors() {
    return (
        <div className="relative overflow-hidden pb-[53px] md:pb-[170px]">
      <figure className="absolute w-[24.2%] top-[9.5%] right-[-13.5%]">
        <img src="/assets/images/deco-03.png" alt="" />
      </figure>
      <figure className="absolute w-[18.66%] bottom-0 left-[-2%]">
            ...
            {data.map((item, index) => (
              ...
              >
                <div className="md:border-8 border-4 border-[#D2BF1F] py-5 md:py-[30px] px-3 md:px-8 bg-white">
                  ...
                  <div className="">
                    <p className="md:text-[23px] text-[14px] font-bold font-mincho md:px-4 px-3 md:py-6 py-4 md:mb-14 mb-8 md:min-h-[176px] min-h-[128px]">
                      {item.body}
                    </p>
                    <div className="flex justify-center md:mb-12 mb-10 max-md:px-3">
                    ...
                    <div className="relative flex justify-end md:px-2">
                      {item.footer}
