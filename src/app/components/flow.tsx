...
const data = [
  ...
  },
  {
    ...
    text: (
      <>
        管理コンソールで簡単に管理できます。全てお任せのサポートプランもご用意しておりますので、お気軽にお問い合わせください。
      </>
    ),
  },
];
...
const Flow = () => {
  ...
  return (
    <section
      id="flow"
      ref={ref}
      className="relative overflow-hidden px-5 md:pt-[90px] pt-10 md:pb-[50px] pb-[30px]"
    >
      <div className="w-full md:max-w-[1360px] max-w-[540px] mx-auto md:gap-[60px] gap-5 flex max-md:flex-wrap xl:justify-start justify-center">
        <div className="fade-up max-xl:w-full flex-1">
          ...
          <p className="md:text-[24px] text-[18px] font-medium tracking-[0.3em] whitespace-nowrap">
            導入フロー
          </p>
        </div>
        <div className="flex gap-7 pt-4 flex-col w-full md:max-w-[630px] max-w-[400px]">
          {data.map((item, index) => (
            <div
              className="fade-up w-full md:h-[174px] bg-white rounded-[20px] shadow-base md:py-8 py-5 md:pl-[30px] px-4 pr-4 flex items-center text-main md:gap-[30px] gap-5"
              key={index}
            >
              <figure>
              ...
              <div className="flex-1">
                <div className="flex md:items-center gap-3 mb-2 max-md:flex-col">
                  ...
                  <p className="md:text-[28px] text-[20px] font-bold">
                    {item.title}
                  </p>
                </div>
