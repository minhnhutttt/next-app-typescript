export default function Footer() {
  return (
    <footer className="bg-black dark:bg-[#FFF7F0] text-white dark:text-black duration-150 pt-[5em] md:pt-[10em] md:px-[2em] px-[1em]">
      ...
      <div className="block"><p className="footer_copyright-text text-[1em]">©<span id="current-year">2024</span>  <a href="/privacy" className="underline">Privacy Policy</a></p> </div>
      </div>
    </footer>
  );
}
