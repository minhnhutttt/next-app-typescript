  ...
  return (
    <section ref={ref} className="bg-[url('/assets/images/fv-bg.png')] max-xl:bg-cover min-[1490px]:bg-[length:100%_100%] bg-top h-[109.063vw] xl:h-[1396px]">
        <div className="w-full max-w-[79.219vw] xl:max-w-[1014px] mx-auto relative">
            <figure className="zoom-out absolute top-[5vw] xl:top-16 left-[6.25vw] xl:left-[80px] max-xl:w-[41.406vw]">
                <img src="/assets/images/kiwi.png" alt="" />
            </figure>
            <figure className="fade-up absolute max-xl:w-[15.469vw] top-[7.031vw] xl:top-[90px] left-[44.688vw] xl:left-[572px]">
                <img src="/assets/images/label-kiwi.png" alt="" />
            </figure>
            <figure className="fade-up absolute max-xl:w-[29.922vw] top-[35.781vw] xl:top-[458px] left-[25.938vw] xl:left-[332px]">
                <img src="/assets/images/package-kiwi.png" alt="" />
            </figure>
            <figure className="fade-up absolute max-xl:w-[8.75vw] top-[3.125vw] xl:top-[40px] left-[62.5vw] xl:left-[800px]">
                <img src="/assets/images/text-kiwi.png" alt="" />
            </figure>
            <div className="fade-up text-[3.359vw] xl:text-[42px] font-hiragino font-semibold absolute top-[60.938vw] xl:top-[780px] leading-relaxed">
            ...
            <figure className="fade-up absolute max-xl:w-[56.797vw] top-[66.406vw] xl:top-[850px] left-[23.438vw] xl:left-[300px]">
