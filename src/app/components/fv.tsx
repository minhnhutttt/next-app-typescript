...
const FV = () => {
  return (
    <section className="relative">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 md:bottom-[210px] bottom-[110px] md:w-[48.958vw] dt:w-[705px] w-[90%] md:h-[15.556vw] dt:h-[224px] mx-auto [clip-path:polygon(0%_0%,_100%_0,_100%_80%,_95%_100%,_0%_100%)] overflow-hidden z-50">
      ...
      <div className="h-[72.569vw] dt:h-[1045px] relative [clip-path:polygon(0_calc(11.5vw),_100%_0%,_100%_100%,_0%_calc(100%-11.5vw))] pt-[14.5vw] -mt-[14.5vw] bg-[url('/assets/images/bg-case.png')] bg-right-bottom bg-no-repeat max-dt:bg-[length:100%_90%]">
        <div className="relative w-full md:max-w-[93.056vw] max-w-[98vw] dt:max-w-[1340px] mx-auto">
          <div className="w-full md:max-w-[72.222vw] max-w-[100%] dt:max-w-[1040px] mx-auto relative">
            <div className="absolute dt:top-[-40px] top-[-2.778vw] left-0">
            ...
            <div className="relative">
              ...
              <div className="flex justify-center py-[3.333vw] dt:py-12">
          ...
          <div className="absolute md:top-[9.722vw] max-md:top-[16vw] dt:top-[140px] right-0">
