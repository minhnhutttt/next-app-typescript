...
export default function FV() {
    ...
    return (
      <section ref={ref} className="bg-[url('/assets/images/fv-bg.png')] bg-bottom bg-[length:100%_100%] pt-7 md:pt-[70px] pb-[44vw] md:pb-[310px] px-5">
        <div className="w-full max-w-[1556px] mx-auto relative">
            <h3 className="absolute max-md:w-[22vw] max-md:max-w-[150px] max-[1560px]:w-[11vw] right-[3vw] md:right-[18.2%] top-0 z-10">
            ...
            <h4 className="absolute max-md:w-[55vw] max-w-[400px] max-[1560px]:w-[37.5vw] left-[16vw] md:left-[25.4%] bottom-0 z-10">
