...
const data = [
  ...
  export default function Habit() {
    ...
    return (
        ...
        <div className="w-full max-w-[1260px] mx-auto max-md:max-w-[440px]">
          <div className="flex items-start max-md:flex-col-reverse">
            <figure className="fade-up relative max-md:w-full max-xl:w-[45%] max-md:mt-10">
              <img src="/assets/images/img-habit-01.png" alt="" />
              <p className="absolute md:top-[88%] top-[90%] left-1/2 max-md:-translate-x-1/2 md:left-10 bg-white border-black border md:text-[19px] text-[15px] md:rounded-[25px] rounded-[12px] p-4 max-w-[290px] w-full">
                毎日の「お茶習慣」で健康的な生活を送りましょう。
              </p>
            </figure>
            <div className="fade-up flex-1 md:mt-14 md:ml-6">
              ...
              <p className="text-[17px] md:text-[20px] font-light mt-8 md:mt-10">
          ...
          <div className="xl:-mt-[12%] max-md:mt-16">
            <div className="fade-up flex justify-center">
              <div className="relative md:ml-[10%]">
                <figure>
                  <img src="/assets/images/img-habit-02.png" alt="" />
                  <p className="md:hidden absolute md:top-[88%] top-[90%] left-1/2 max-md:-translate-x-1/2 md:left-10 bg-white border-black border md:text-[19px] text-[15px] md:rounded-[25px] rounded-[12px] p-4 max-w-[290px] w-full">
                    妊婦さんや小さなお子様でもノンカフェインだから安心
                  </p>
                </figure>
              </div>
            </div>
            <div className="fade-up flex max-md:mt-16">
              <div className="relative md:ml-[22%] md:-mt-[8%]">
                <figure className="">
                  <img src="/assets/images/img-habit-03.png" alt="" />
                  <p className="absolute md:top-[55%] left-1/2 max-md:-translate-x-1/2 top-[90%] md:left-[76%] bg-white text-[15px] md:text-[19px] md:rounded-[25px] border-black border rounded-[12px] p-4 max-w-[290px] w-full">
          ...
          <div className="fade-up flex justify-center mt-[100px] md:mt-16">
            <div className="w-full max-w-[1107px] md:h-[411px] max-md:rounded-[54px] bg-[length:100%_100%] md:bg-[url('/assets/images/bg-box.png')] max-md:bg-[#7BB658] flex py-9 md:pt-[80px] justify-center px-4 md:px-10">
          ...
          <div className="w-full max-w-[1000px] mx-auto mt-[60px] md:mt-[180px]">
            <div className="md:border-8 border-4 border-[#8BD3AC] md:rounded-[98px] rounded-[54px] pb-10 md:pb-[80px] pt-6 md:pt-[53px] bg-[#FBFFE3]">
              <h5 className="fade-up md:text-[45px] text-[24px] font-bold font-mincho text-center">
                柿の葉茶の淹れ方
              </h5>
              <div className="w-full max-w-[834px] mx-auto md:space-y-[80px] space-y-[40px] mt-5 px-5">
                {data.map((item, index)=> (
          ...
          <div className="w-full max-w-[1184px] mx-auto bg-white border-[3px] border-[#B1B155] rounded-[54px] md:rounded-[99px] px-5 pt-8 md:pt-[44px] md:pb-[126px] pb-[50px] mt-[50px] md:mt-[170px]">
          <h5 className="fade-up md:text-[42px] text-[25px] text-center font-mincho font-bold border-b border-black md:pb-6 pb-4">
            お客様の声
          </h5>
          <div className="mt-[90px] md:px-5 space-y-[50px] w-full max-w-[1016px] mx-auto">
          {dataVoice.map((item, index)=> (
                    ...
                    <div className="flex-1 max-w-[644px] bg-[#FBF5BD] md:rounded-[54px] rounded-[27px] border-[#708713] border p-5 md:p-10 min-h-[320px]">
                      <h5 className="md:text-[28px] max-md:text-center text-[20px] font-bold">
                        {item.title}
                      </h5>
                      <p className="md:text-[21px] text-[17px] font-light mt-5 md:mt-8">
                        {item.body}
                      </p>
                    </div>
                  </div>
