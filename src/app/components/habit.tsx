    ...
    <section ref={ref} className="bg-[#E0DDCF] md:pt-[134px] pt-[70px] px-5">
        <div className="w-full max-w-[1080px] mx-auto bg-white/50 md:px-[50px] px-5 pt-10 md:pt-[68px] md:pb-[252px] pb-[160px]">
            ...
            <div className="w-full max-w-[850px] mx-auto mt-12 md:mt-[100px] md:space-y-24 space-y-12">
                <div className="flex max-md:flex-col max-md:items-center justify-center gap-5 md:gap-20">
                    <figure>
                ...
                <div className="flex max-md:flex-col max-md:items-center justify-center md:flex-row-reverse gap-5 md:gap-20">
                    <figure>
            ...
            <div className="w-full max-w-[805px] mx-auto mt-16 md:mt-[110px]">
                <div className="bg-[#8BAB2D] md:rounded-[72px] rounded-[32px] md:text-[21px] text-[16px] font-hiragino font-semibold text-white md:p-8 p-8 xl:p-16 leading-loose">
