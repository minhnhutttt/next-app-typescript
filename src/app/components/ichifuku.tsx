  ...
  return (
    <section ref={ref} className="bg-[url('/assets/images/bg-ichifuku.png')] bg-[length:100%_auto] bg-bottom bg-no-repeat bg-[#76A406] md:pb-[84px] pb-10 border-b-2 border-white">
        ...
        <div className="w-full max-w-[912px] mx-auto mt-6 md:mt-10 px-5">
            <h3 className="text-center font-hiragino text-white font-semibold md:text-[48px] text-[18px]">
            ...
            <div className="md:text-[22px] text-[14px] font-semibold text-white bg-[#337223] border-2 border-white rounded-[44px] md:px-[52px] md:py-[30px] px-5 py-4 md:mt-12 mt-6 leading-[1.75]">
            他社とは一線を画す一福のドライキウイ。皮つきのまま提供する事で、皮に多く含まれる栄養素（葉酸や食物繊維、ビタミン類など）を、丸ごとお届けできます。通常キウイの皮自体は苦みや固さなどがあるため剥いて食べるものですが、栄養補給の為に無理をして自分で皮を洗って食べてる人も...。<br />果肉のみよりもはるかにたくさん栄養を摂取でき、尚且つ美味しく食べられるような商品にしてますので、美味しくないと思ってる人も、「クセになるほど」美味しく食べられます。「自然そのものを美味しく」をモットーにしているからこそ安心です。
            </div>
            <div className="flex justify-center items-center gap-8 mt-7 md:mt-10">
                <figure>
            ...
            <div className="text-center text-white md:text-[34px] text-[17px] font-hiragino mt-8 md:mt-12">
