import Title from "@/components/title";
  ...
  export default function Intro() {
    return (
        <div className="md:bg-[url('/assets/images/bg-01.png')] bg-[url('/assets/images/bg-01_sp.png')] bg-[length:100%_100%] px-5 pb-[170px] md:pb-[320px] md:pt-[165px] pt-[80px]">
        <div className="w-full md:max-w-[1344px] max-w-[440px] mx-auto max-md:flex-col flex md:pl-[66px] max-md:items-center md:justify-end">
          ...
          <div className="flex-1 md:ml-[8%] max-md:flex-col-reverse flex max-md:items-center max-md:mt-4">
            <p className="text-[17px] md:text-[21px] font-light text-white flex-1">
            ...
            <figure className="md:ml-[5%] max-md:mb-5 md:w-[41.31%]">
              <img
