  ...
  return (
    <section ref={ref} className="bg-[url(/images/bg-02.jpg)] bg-center">
      ...
      <div className="py-12 px-5 md:py-20">
        <div className="fade-up flex justify-center">
          <img
            className="[box-shadow:0px_0px_30px_0px_rgba(0,_0,_0,_0.10)] max-md:w-[140px]"
            src="/images/diver-biz.png"
            alt="DIVER Biz"
          />
        </div>
        <div className="fade-up text-center mt-6 md:mt-12 max-md:space-y-2">
          <p className="md:text-[24px] text-[14px] leading-none font-black">
            ダイバービズ
          </p>
          <h3 className="md:text-[68px] text-[34px] font-black leading-none">
            DIVER Biz<span className="md:text-[42px] text-[21px]">を</span>
          </h3>
          <p className="md:text-[42px] text-[21px] font-black">
            今すぐインストール
          </p>
          <p className="text-center md:text-[16px] text-[13px] max-md:leading-[2] duration-300 hover:opacity-75">
            ※NFT名刺の制作は
            <a
              href="/form"
              className="font-bold inline-block relative after:absolute after:top-full after:left-0 md:after:h-[3px] after:h-[2px] after:w-full after:bg-black after:rounded-3xl"
            >
              フォーム
            </a>
            からの申請が必要です（アプリ内で制作はできません）
          </p>
        </div>
