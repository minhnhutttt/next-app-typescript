...
const Kizuna = () => {
    return (
      <section className="overflow-hidden gradient-02 md:pt-[160px] md:pb-[187px] pt-20 pb-24">
        <div className="w-full max-w-[1440px] mx-auto bg-white xl:rounded-[200px] lg:rounded-[100px] rounded-[20vw] md:pt-20 pt-14 md:px-[70px] px-6 overflow-hidden">
            <div className="md:text-[48px] text-[24px] font-bold text-center">日本初「産官学」で <br className="md:hidden" />支える信頼の絆</div>
            <div className="md:mt-[91px] mt-16 gradient-03 md:rounded-[80px] rounded-[10vw] [filter:drop-shadow(0px_4px_100px_rgba(78,_64,_162,_0.30))] w-full md:max-w-[1300px] max-w-[1300px] mx-auto xl:px-[197px] md:px-[100px] px-6 md:pt-[100px] md:pb-[111px] py-[60px] relative">
                <span className="absolute md:left-[-32px] left-[-10px] md:top-[-40px] top-[-60px]">
                    <img className="max-md:w-[100px] max-xl:w-[140px]" src="/assets/images/slider-animal-07.png" alt="" />
                </span>
                <span className="absolute md:left-[-70px] left-[-20px] md:top-[260px] max-md:bottom-[-64px]">
                    <img className="max-md:w-[110px] max-xl:w-[150px]" src="/assets/images/slider-animal-08.png" alt="" />
                </span>
                <p className="md:text-[24px] text-[16px] text-white font-bold md:max-w-[908px] max-w-[540px] mx-auto w-full leading-[2.1]">
                ...
                <span className="absolute md:right-[-70px] right-[-20px] xl:bottom-[-120px] md:bottom-[-70px] bottom-[-90px]">
                    <img className="max-md:w-[140px] max-xl:w-[200px]" src="/assets/images/slider-animal-09.png" alt="" />
                </span>
            </div>
            <div className="w-full max-w-[1022px] mx-auto md:pt-[150px] pt-32">
                ...
                <div className="md:pt-[76px] pt-12 md:space-y-10 space-y-7 px-2 pb-7">
                    <div>
                ...
                <div className="gradient-03 md:p-10 p-6 rounded-[20px] md:text-[18px] text-[14px] font-bold text-white">
                『メタでペット供養』は、<br />
                沖縄県宮古島市狩俣自治会、琉球大学島嶼地域科学研究所、そして株式会社メタロポリス<br />
                <br />
                の3つの組織が手を携えて生み出したサービスです。各組織が持つ専門性とペット供養への想いが結集し、ペットとの絆を大切にする方々に寄り添うことで誕生しました。
                </div>
                <div className="flex justify-center items-center md:mt-[86px] mt-14">
                    <img src="/assets/images/serif.png" alt="" />
                </div>
                <div className="w-full md:max-w-[913px] max-w-[540px] mx-auto md:text-[18px] text-[14px] font-medium mt-10 md:mt-16">
                ...
                <div className="md:h-[490px] h-[70vw] overflow-hidden">
