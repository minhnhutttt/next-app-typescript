  ...
  return (
    <section className="bg-[#01B202] p-[50px] flex justify-center">
        <div className="w-full max-w-[630px] mx-auto bg-white rounded-[30px] flex items-center px-7 py-[30px] gap-10 max-md:flex-col">
            ...
            <div className="">
                <div className="md:text-[24px] text-[14px] font-bold underline tracking-widest">サポートLINEのご案内</div>
                <div className="md:text-[18px] text-[13px] mt-2 space-y-3">
                    <div className="flex items-center gap-2.5">
                        <figure>
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="17" viewBox="0 0 18 17" fill="none">
                                <path d="M0.461304 0V17H17.4613V6.01076L14.6722 8.79982V14.2109H3.25037V2.78906H8.66148L11.4505 0H0.461304ZM15.0531 0.214781L8.9022 6.36666L6.70455 4.16901L4.45089 6.42371L8.9021 10.8739L11.1558 8.62025L17.3066 2.46837L15.053 0.214724L15.0531 0.214781Z" fill="#01B202"/>
                            </svg>
                        </figure>
