...
import { dataAD, dataAI, dataBlockChain, dataFx, dataMarketing, dataWebSite, getTranslationByLang, RankData } from "../data/data";
            ...
            <div className="">
              {dataAI.length > 0 && (
                <div className="flex flex-col border-b border-black/30 dark:border-white/30 gap-2 px-5 md:px-2 py-4">
                  <Link
                    onClick={close}
                    href={getLocalizedPath(dataAI[0].link, lang)}
                  ...
                  >
                    <p className="text-[13px] font-hiragino dark:text-white leading-snug">
                      {getTranslationByLang(dataAI[0], lang)?.title}
                    </p>
                  </Link>
                </div>
              )}
              {dataBlockChain.length > 0 && (
                <div className="flex flex-col border-b border-black/30 dark:border-white/30 gap-2 px-5 md:px-2 py-4">
                  <Link
                    onClick={close}
                    href={getLocalizedPath(dataBlockChain[0].link, lang)}
                    className="flex items-center relative duration-150 hover:opacity-75"
                  >
                    <p className="text-[13px] font-hiragino dark:text-white leading-snug">
                      {getTranslationByLang(dataBlockChain[0], lang)?.title}
                    </p>
                  </Link>
                </div>
              )}
              {dataWebSite.length > 0 && (
                <div className="flex flex-col border-b border-black/30 dark:border-white/30 gap-2 px-5 md:px-2 py-4">
                  <Link
                    onClick={close}
                    href={getLocalizedPath(dataWebSite[0].link, lang)}
                    className="flex items-center relative duration-150 hover:opacity-75"
                  >
                    <p className="text-[13px] font-hiragino dark:text-white leading-snug">
                      {getTranslationByLang(dataWebSite[0], lang)?.title}
                    </p>
                  </Link>
                </div>
              )}
              {dataAD.length > 0 && (
                <div className="flex flex-col border-b border-black/30 dark:border-white/30 gap-2 px-5 md:px-2 py-4">
                  <Link
                    onClick={close}
                    href={getLocalizedPath(dataAD[0].link, lang)}
                    className="flex items-center relative duration-150 hover:opacity-75"
                  >
                    <p className="text-[13px] font-hiragino dark:text-white leading-snug">
                      {getTranslationByLang(dataAD[0], lang)?.title}
                    </p>
                  </Link>
                </div>
              )}
              {dataMarketing.length > 0 && (
                <div className="flex flex-col border-b border-black/30 dark:border-white/30 gap-2 px-5 md:px-2 py-4">
                  <Link
                    onClick={close}
                    href={getLocalizedPath(dataMarketing[0].link, lang)}
                    className="flex items-center relative duration-150 hover:opacity-75"
                  >
                    <p className="text-[13px] font-hiragino dark:text-white leading-snug">
                      {getTranslationByLang(dataMarketing[0], lang)?.title}
                    </p>
                  </Link>
                </div>
              )}
              {dataFx.length > 0 && (
                <div className="flex flex-col border-b border-black/30 dark:border-white/30 gap-2 px-5 md:px-2 py-4">
                  <Link
                    onClick={close}
                    href={getLocalizedPath(dataFx[0].link, lang)}
                    className="flex items-center relative duration-150 hover:opacity-75"
                  >
                    <p className="text-[13px] font-hiragino dark:text-white leading-snug">
                      {getTranslationByLang(dataFx[0], lang)?.title}
                    </p>
                  </Link>
                </div>
              )}
