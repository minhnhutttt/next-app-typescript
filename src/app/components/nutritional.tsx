...
import useScrollAnimations from "@/hooks/useScrollAnimations";
  ...
  export default function Nutritional() {
    ...
    return (
        <div ref={ref} className="px-4 pt-[90px] md:pt-[175px] pb-[100px] md:pb-[205px] relative bg-[url('/assets/images/deco-01.png')] bg-no-repeat max-md:bg-[length:33%_auto] bg-left-top">
        <div className="w-full max-w-[1150px] mx-auto">
          ...
          <div className="mt-12 md:mt-[108px] max-md:max-w-[440px] mx-auto">
            <div className="fade-up flex items-center justify-center mb-6 md:mb-[92px]">
              <img src="/assets/images/img-chart.png" alt="" />
            </div>
            <h3 className="fade-up text-center font-mincho text-[19px] md:text-[36px] font-bold">
              様々な健康成分を満足に摂りたいなら
              <br />
              緑茶よりも柿の葉茶が一番！
            </h3>
            <p className="fade-up text-[17px] md:text-[20px] font-light max-w-[980px] mx-auto w-full mt-9 leading-relaxed  max-md:px-4 max-md:leading-snug">
              ...
              <br />
              <br />
              グラフにあるように、<span className="font-bold">含まれている重要な栄養素の値がそれぞれ10倍以上</span>もする事から、あなたの生活の一部になる事ができればきっと健康的な未来をより一層明るくしてくれます。
            </p>
          </div>
        </div>
      </div>
