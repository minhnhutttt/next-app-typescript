...
const data = [
  ...
  },
  {
    ...
    text: (
      <>
        物件情報を効果的に提供し、NFTクーポンで特典を付与。位置情報で顧客の見学をスムーズにサポート！
      </>
    ),
  },
  {
    ...
    text: (
      <>
        旅行をもっとお得に、楽しく！
        <br />
        NFTクーポンでご当地特典や限定アイテムを提供し、旅を充実させます！
      </>
    ),
  },
  {
    ...
    text: (
      <>
        キャンパスライフをもっと便利に、楽しく！
        NFTクーポンで学内特典やイベント情報を提供し、充実した学生生活をサポート！
      </>
    ),
  },
  {
    ...
    text: (
      <>
        NFTクーポンでVIPシート、限定グッズ、特別イベント招待など、ファンとのエンゲージメントを高める多彩な特典を提供！
      </>
    ),
  },
  {
    ...
    text: (
      <>
        NFTクーポンで区内の店舗やイベント特典を提供！位置情報機能で移動をスムーズにし、住民や観光客の満足度を高めます！
      </>
    ),
  },
];
