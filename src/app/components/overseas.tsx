...
const Overseas = () => {
  ...
  return (
    <section ref={ref} className="md:my-[80px] my-14 px-5">
        <div className="fade-up w-full max-w-[1100px] mx-auto border-[#EB001C] border bg-white rounded-[20px] xl:px-[57px] px-5 md:pt-20 pt-12 md:pb-10 pb-6">
            <div className="flex max-md:flex-col max-md:items-center gap-10 xl:gap-[52px]">
                <div className="fade-up md:mt-4">
            ...
            <div className="fade-up flex justify-center mt-6 md:mt-8 w-full max-w-[762px] mx-auto">
