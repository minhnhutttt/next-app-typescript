  ...
  return (
    <div className="md:mt-[170px] mt-[120px] px-5 md:mb-[88px] mb-11">
        <div className="w-full md:max-w-[1106px] max-w-[480px] mx-auto">
            <h3 ref={animateRefs} className="opacity-0 text-center md:text-[42px] text-[24px] font-bold">ご解約を希望される方へ</h3>
            <div ref={animateRefs} className="opacity-0 flex items-center max-md:flex-col gap-6 md:gap-9 md:mt-[70px] mt-10">
                <figure className="max-md:w-auto max-lg:w-[50%]">
                    <img className="max-md:max-w-[320px] max-md:w-full" src="/images/image-cancel.png" alt="" />
                </figure>
