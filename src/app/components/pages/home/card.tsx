...
export default function Card({ children }: CardProps) {
  ...
  return (
    <div
    className="w-1/2 md:w-1/4 px-2.5 md:px-[15px] max-w-[323px] "
      onMouseMove={handleMouseMove}
      onMouseEnter={handleMouseEnter}
      onMouseLeave={handleMouseLeave}
      ref={cardRef}
    >
      <div className="w-full rounded-xl border border-[#939393] max-md:p-3 z-20 h-full overflow-hidden relative [transition:1s_cubic-bezier(0.445,_0.05,_0.55,_0.95)]" style={cardStyle}>
        <div>
          {children}
        </div>
      </div>
