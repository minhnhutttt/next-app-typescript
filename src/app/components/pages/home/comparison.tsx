              ...
              <tbody>
                <tr>
                  ...
                  <th className="md:h-[112px] h-[80px] align-middle px-2 md:px-4 border border-[#D9D9D9] bg-white">
                    <p className="lg:text-[72px] md:text-[54px] text-[28px] font-bold">
                      E
                      <span className="relative -top-1 md:-top-1.5 lg:text-[48px] md:text-[32px] text-[18px]">
                        社
                      </span>
                    </p>
                  </th>
                ...
                <tr>
                  <td className="md:h-[112px] h-[80px] align-middle px-2 md:px-4 border border-[#D9D9D9] bg-white lg:text-[36px] md:text-[28px] text-[16px] text-center font-bold break-keep">
                    表示の速さ
                  </td>
