...
export default function Card({ image, title, children, color }: CardPropsType) {
  ...
  return (
    <div ref={animateUpRefs} className="opacity-0 font-bold md:min-h-[480px] md:max-w-[420px] max-w-[380px] lg:rounded-[60px] rounded-[30px] md:border-[5px] border-[3px] p-3 lg:p-5" style={{borderColor: color ?? "#0055A3"}}>
        <figure>
