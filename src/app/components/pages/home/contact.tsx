            ...
            <div ref={ref}>
                ...
                <div className="content-scroll-keep px-8 w-full md:max-w-[1160px] max-w-[600px] mx-auto mt-3 md:mt-2 relative pb-14 md:pb-[180px]">
                    ...
                    <div className="fade-down flex justify-center mt-10 md:mt-20">
                        <a href="https://lin.ee/VhROyxa" className="w-[317px] h-[63px] rounded-[32px] bg-[#74DB0D] flex items-center justify-center md:text-[20px] text-[18px] font-bold text-[#404040]" target="_blank">LINE登録はこちら</a>
                    </div>
                    <div className="fade-down flex justify-center mt-8">
                        <p className="md:text-[20px] text-[17px] font-bold text-[#404040]">
