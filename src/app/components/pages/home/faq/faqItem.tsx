...
export default function FaqItem({ id, question, answer }: FaqItemPropsType) {
  ...
  return (
    <div
      ref={animateRefs}
      className="space-y-2 rounded-[20px] border border-[#FDD300] bg-white/90 p-4 md:px-8 md:pb-8 md:pt-10"
    >
      <button
        type="button"
      ...
      >
        <div className="flex items-center gap-4 md:gap-8">
          <p className="font-roboto text-[18px] font-bold text-[#FDD300] uppercase tracking-widest md:text-[32px]">
            q
          </p>
