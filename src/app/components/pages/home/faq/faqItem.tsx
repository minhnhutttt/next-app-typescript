...
export type FaqItemPropsType = {
  ...
  return (
    <div
      ref={animateRefs}
      className="space-y-2 rounded-[20px] border border-[#FF66CC] bg-white/90 p-4 md:px-8 md:pb-8 md:pt-10"
    >
      <button
        type="button"
      ...
      >
        <div className="flex items-center gap-4 md:gap-8">
          <p className="font-roboto text-[18px] font-bold text-[#FF66CC] uppercase tracking-widest md:text-[32px]">
            q
          </p>
          <p className="text-left text-[16px] font-bold text-[#FF66CC] md:text-[22px]">
            {question}
          </p>
        </div>
        <div
        ...
        >
            ...
            <circle cx="24" cy="24" r="23.5" transform="rotate(-180 24 24)" stroke="#FF66CC"/>
            <path d="M28.2667 21.8667L24 26.1334L19.7333 21.8667" stroke="#FF66CC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
        </div>
      </button>
