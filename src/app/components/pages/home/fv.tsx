...
export default function FV() {
  ...
  return (
    <section className="md:bg-[url('/images/bg.png')] bg-[url('/images/bg-sp.png')] md:bg-cover bg-[length:100%_auto] bg-black bg-bottom bg-no-repeat px-5 md:pb-[50px] pb-10 md:pt-[124px] pt-20">
      <div className="w-full max-w-[1340px] mx-auto flex max-md:gap-6 max-md:flex-col justify-center max-md:items-center md:justify-between pl-[1.667vw] min-[1440px]:pl-6">
        <div className="font-zenOld relative text-white max-md:text-center [font-size:_clamp(20px,9.2vw,58px)] md:text-[6.597vw] min-[1440px]:text-[94px] font-black leading-tight mt-8 md:mt-14 tracking-wide">
          <span ref={animateLeftRefs} className="inline-block opacity-0">
            紙の制約を超えろ
          </span>{" "}
          <br />
          <span ref={animateRightRefs} className="inline-block opacity-0">
            デジタルの自由を
          </span>{" "}
          <br />
        ...
        <div
          ref={animateRefs}
          className="max-md:w-auto max-[1439px]:w-[37.222vw] opacity-0 relative z-10"
        >
          <figure>
            <img
