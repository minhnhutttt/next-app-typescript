  ...
  return (
    <div className="md:pb-[100px] pb-[60px] px-5 md:px-8">
      <div className="w-full md:max-w-[1400px] max-w-[640px] mx-auto max-md:flex max-md:flex-col-reverse">
        <div
          ref={animateRefs}
          className="opacity-0 flex md:h-[110px] justify-center md:justify-end items-center gap-4 md:gap-5 max-md:flex-wrap max-md:mt-10"
        >
          <a
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="max-md:w-[40vw] max-md:max-w-[200px] max-lg:max-w-[160px] duration-150 hover:opacity-75"
          >
