        ...
        <div className="bg-[#FF9B9B] max-md:p-5 py-8 md:py-10">
            <div ref={animateZoomRefs} className="opacity-0 flex max-md:flex-col max-md:items-center">
                ...
                <div ref={animateRefs} className="opacity-0 text-white pt-5 md:pt-[2.222vw] min-[1440px]:pt-8 px-[2.5vw] min-[1440px]:px-10 flex-1 ">
                    ...
                    誰でも<span className="relative after:absolute after:bottom-[-6px] md:after:bottom-[-10px] after:left-1/2 after:-translate-x-1/2 after:w-3 md:after:w-[1.667vw] after:aspect-square min-[1440px]:after:w-6 after:rounded-full after:bg-[#FE4848]">簡</span><span className="relative after:absolute after:bottom-[-6px] md:after:bottom-[-10px] after:left-1/2 after:-translate-x-1/2 after:w-3 md:after:w-[1.667vw] after:aspect-square min-[1440px]:after:w-6 after:rounded-full after:bg-[#FE4848]">単</span>!!
                    </h1>
