      ...
      <div className="flex max-md:flex-col w-full  mx-auto gap-8 pt-[140px] pb-20 md:pb-[114px] md:pt-[65px]">
        ...
        >
          ...
          <div className="text-center font-bold tracking-[0.65em] leading-[1.3] mt-5">
            <p className="text-[10vw] md:text-[7.431vw] min-[1440px]:text-[107px]">
              <span className="text-[9.8vw] md:text-[7.292vw] min-[1440px]:text-[105px]">
                と
              </span>
              貼るだけ
            </p>
            <p className="text-[11.5vw] md:text-[9.097vw] min-[1440px]:text-[131px]">
              簡単証明
            </p>
          </div>
        </div>
