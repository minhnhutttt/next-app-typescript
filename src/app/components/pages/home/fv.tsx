...
function FText({ delay = "0.1", children }: FTextPropsType) {
  return (
    <span
      className="animate-[fade-in_0.8s_forwards_cubic-bezier(0.11,_0,_0.5,_0)] opacity-0 filter blur-sm"
    ...
    <section className="relative">
      <div className="bg-[#FF9B9B] max-md:p-5 py-8 md:py-10">
        <div className="flex max-md:flex-col max-md:items-center">
          ...
          <div className="text-white pt-5 md:pt-[2.222vw] min-[1440px]:pt-8 px-[2.5vw] min-[1440px]:px-10 flex-1 scale-[0.9] animate-[scale_3s_forwards_cubic-bezier(0.5,_1,_0.89,_1)]">
