    ...
    <section className="px-5 bg-[url('/images/bg-06.png')] bg-cover">
      <div className="w-full max-w-[1260px] mx-auto pt-[8.611vw] min-[1440px]:pt-[124px] pb-[5vw] min-[1440px]:pb-9">
        ...
        <div className="bg-white px-6 md:px-[50px] py-10 md:py-20 w-full max-w-[900px] mx-auto rounded-[40px]">
          <div className="mx-auto flex w-full gap-8 max-md:flex-col md:gap-[64px] border-b border-[#1853A0] pb-6 md:pb-10">
            <div className="flex flex-col items-center justify-center md:pl-[22px]">
            ...
            <div className="md:pt-4">
              <div className="w-full max-w-[427px] max-md:mx-auto space-y-7">
          ...
          <div className="">
            <h5 className="text-center">ご利用には次世代アドレスが必要です</h5>
          </div>
        </div>
      </div>
    </section>
