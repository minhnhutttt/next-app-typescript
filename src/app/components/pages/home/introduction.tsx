...
export default function Introduction() {
  ...
  return (
    <section className="pt-[50px]">
        ...
        <div ref={animateRefs} className="opacity-0 bg-[url('/images/bg-01.png')] bg-center bg-no-repeat bg-[length:100%_auto] md:mt-[58px] mt-[30px] md:mb-[61px] mb-8">
        ...
        <div className="px-4">
          <div ref={animateRefs} className="opacity-0 relative z-10 w-full max-w-[904px] mx-auto rounded-[10px] overflow-hidden bg-[url('/images/bg-present.png')] bg-cover p-5 md:p-7">
            <div className="border border-[#333333] rounded-[10px] text-center px-3 md:px-5 pb-6">
              <div className="flex justify-center -mt-3">
                <img className="max-md:w-[160px]" src="/images/present.png" alt="PRESENT" />
              </div>
              <p className="text-[16px] md:text-[20px] lg:text-[24px] font-bold mt-2 md:mt-1 tracking-[0.4em]">全てのビジネスマンに未来を実装！</p>
              <p className="lg:text-[34px] md:text-[24px] text-[20px] font-black tracking-[0.2em] leading-tight max-md:mt-3"><span className=" border-b-2 border-[#323232]">あなたの次世代名刺<span className="md:text-[48px] text-[32px] lg:text-[74px]">200</span>枚プレゼント</span></p>
              <p className="font-bold lg:text-[28px] md:text-[22px] text-[18px] my-4">さぁ、今すぐ画像を用意してNFT名刺を手に入れよう！</p>
              <div className="flex justify-center">
                <a href="/" className="md:w-[426px] md:h-[85px] w-[260px] h-[48px] flex items-center justify-center rounded-[44px] bg-[#F4EA00] md:border-4 border-2 border-black md:text-[31px] text-[17px] md:gap-2.5 gap-1.5 font-bold tracking-widest">
                  <span>無料で200枚つくる</span>
                  <svg className="max-md:w-8" xmlns="http://www.w3.org/2000/svg" width="49" height="15" viewBox="0 0 49 15" fill="none">
                    <path d="M0.5 14H46.5L33.5 1" stroke="black" strokeWidth="2"/>
                  </svg>
                </a>
              </div>
              <p className="lg:text-[18px] md:text-[14px] text-[12px] font-bold md:tracking-[0.5em] tracking-[0.2em] mt-2">※名刺情報のフォーム入力が必要です。</p>
            </div>
          </div>
        </div>
    </section>
