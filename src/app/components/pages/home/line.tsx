  ...
  return (
    <section className="relative px-4">
      <div className="w-full max-w-[730px] mx-auto">
        <div
          ref={animateRefs}
          className="opacity-0 flex max-md:flex-col bg-[#00B900] rounded-[20px] py-5 md:px-10 px-8"
        >
        ...
        <div
          ref={animateRefs}
          className="opacity-0 flex justify-center md:my-7 my-6"
        >
          <img src="/images/line-deco.png" alt="" />
        </div>
        <div
          ref={animateRefs}
          className="opacity-0 rounded-[30px] overflow-hidden border border-[#00B900]"
        >
          <p className="bg-[#00B900] md:px-10 px-5 text-white md:text-[18px] text-[14px] py-3 flex items-center md:py-4">
            LINEなら気軽にやりとりができるので、スピーディーに話が進みます。{" "}
            <br />
