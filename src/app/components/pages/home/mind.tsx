...
type MindItemPropsType = {
  ...
  function MindItem({ image, title, children }: MindItemPropsType) {
    return (
        <div className="w-[282px] h-[280px] md:h-[320px] bg-white border border-[#FE4848] p-[30px] rounded-[30px] [box-shadow:4px_4px_30px_0px_rgba(0,_0,_0,_0.10)]">
    ...
    return (
      <section className="relative md:mb-[130px] mb-8 px-4">
          ...
          <h4 className="flex items-center justify-center gap-2 md:gap-[30px] md:px-8">
                ...
                <p className="md:text-[48px] text-[24px] font-medium tracking-widest text-center leading-none">次世代証明書導入サポート<br />安心<span className="text-[#FE4848]"><span className="md:text-[90px] text-[40px]">5</span>つ</span>のお約束</p>
                <span className="flex-1 h-[3px] md:h-[5px] bg-black max-md:min-w-[24px] max-w-[110px]"></span>
            </h4>
