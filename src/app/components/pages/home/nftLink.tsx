        ...
        <div className="bg-[linear-gradient(_to_bottom,_rgba(246,_250,_254,_0.80)_0%,_rgba(246,_250,_254,_0.80)_calc(100%-172px),_transparent_calc(100%-172px),_transparent_100%_)] px-5 md:px-8 pt-20 md:pt-[205px]">
            <div className="w-full max-w-[1320px] mx-auto">
                <section className="mb-[100px]">
                    ...
                    <div className="bg-white [box-shadow:0px_4px_44px_0px_rgba(24,_83,_160,_0.15)] rounded-[20px] mt-14 md:mt-24 p-6 md:p-10">
                        <div className="w-full md:max-w-[730px] max-w-[400px] mx-auto flex justify-between pt-10 pb-5 md:pb-6 max-md:flex-col max-md:gap-10">
                            <div className="">
                                <div className="flex justify-center">
                ...
                <section>
                    <div className="text-center relative mb-2.5 px-2.5 pb-6 md:pb-9 bg-[repeating-linear-gradient(-45deg,_transparent_0_6px,_#0055A3_6px_8px)] bg-no-repeat md:[background-size:100%_20px] [background-size:100%_12px] bg-bottom">
                        <h3 className="md:text-[62px] [font-size:_clamp(20px,7.5vw,32px)] font-bold tracking-[0.15em]">NFTの受け取り方法</h3>
                    </div>
                    <div className="flex justify-center items-center max-md:flex-col gap-6 md:mt-12 mt-8 md:gap-[96px]">
                        <figure>
                            <img className="rounded-[35px]" src="/images/image-receive-left.png" alt="" />
                        </figure>
                        <figure>
                            <img className="max-md:max-w-[300px] max-md:w-[45vw]" src="/images/image-receive-right.png" alt="" />
                        </figure>
                    </div>
                    <div className="bg-white [box-shadow:0px_4px_44px_0px_rgba(24,_83,_160,_0.15)] rounded-[20px] mt-10 md:mt-16 px-4 py-6 md:p-10">
                        <div className="w-full max-w-[1060px] mx-auto pb-8 md:pb-14">
                            <h5 className="text-center font-bold font-noto lg:text-[32px] md:text-[28px] [font-size:_clamp(18px,6.4vw,24px)] mt-8 md:mt-16">①表示されてるURLに<br className="md:hidden" />アクセスする</h5>
                            <div className="flex items-center justify-center max-md:flex-wrap mt-8 md:mt-12">
                                ...
                                <p className="lg:text-[32px] md:text-[28px] [font-size:_clamp(14px,5vw,20px)] text-center font-bold font-noto lg:p-[30px] px-[2vw] md:p-5 whitespace-nowrap">または</p>
                                <figure className="max-md:w-[29vw]">
                                    <img src="/images/image-access-02.png" alt="" />
                                </figure>
                                <p className="max-md:w-full lg:p-[30px] p-10 md:p-5">
                                    <img className="max-md:rotate-90 max-md:w-[80px] mx-auto" src="/images/arrow.png" alt="" />
                                </p>
                                <figure className="max-md:w-[29vw]">
                    ...
                    <div className="bg-white [box-shadow:0px_4px_44px_0px_rgba(24,_83,_160,_0.15)] rounded-[20px] mt-10 md:mt-28 px-4 py-6 md:p-10">
                        <div className="w-full max-w-[1060px] mx-auto pb-8 md:pb-14">
                            <h5 className="text-center font-bold font-noto lg:text-[32px] md:text-[28px] [font-size:_clamp(18px,6.4vw,24px)] mt-8 md:mt-16">②NFTを確認して受け取る</h5>
                            <div className="flex items-center justify-center max-md:flex-wrap mt-8 md:mt-12">
                                <figure className="max-md:w-[29vw]">
