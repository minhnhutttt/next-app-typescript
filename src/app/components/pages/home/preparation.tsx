         ...
         <div ref={animateZoomRefs} className="opacity-0 w-full max-w-[1123px] mx-auto p-3 md:p-[22px] bg-[repeating-linear-gradient(_-60deg,_#FFE178,_#FFE178_20px,_#000_20px,_#000_40px_)] rounded-[40px]">
            <div className="w-full h-full bg-[#FFD900] lg:px-[60px] md:px-10 px-6 py-5 rounded-[40px]">
                ...
                <div className="flex justify-center mt-5">
                    ...
                    火事や事故、災害など、何が起きるかわからない世の中です。<br />何かが起きても耐えられる仕組みを取り入れておくことは、組織に属する人々に安心感を与えてくれます。
                    </p>
                </div>
                <div className="flex justify-center mt-3">
                    <div className="md:text-[24px] text-[15px] font-medium space-y-5 py-3">
                        <div className="flex items-center gap-2">
                            <figure><img className="max-md:w-6" src="/images/ic-check.svg" alt="" /></figure>
                ...
                <p className="text-center md:text-[28px] font-bold text-[18px] md:mt-6 mt-4">次世代証明書で組織運営者としての責任を果たしましょう！</p>
            </div>
         </div>
      </section>
    );
