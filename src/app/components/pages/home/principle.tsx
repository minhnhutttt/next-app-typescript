                    ...
                    <div className="content-scroll-keep px-5 w-full max-w-[860px] mx-auto mt-3 md:mt-5 pb-[120px] md:pb-[216px]">
                        ...
                        <div className="fade-down md:mt-10 mt-6 md:space-y-16 space-y-10 max-md:max-w-[327px] max-md:mx-auto">
                            <div className="flex max-md:flex-col md:gap-[38px] gap-6">
                                ...
                                <div className="flex-1 md:text-[17px] text-[16px] font-medium leading-snug">
                            ...
                            <div className="flex max-md:flex-col md:gap-[38px] gap-6">
                                ...
                                <div className="flex-1 md:text-[17px] text-[16px] font-medium leading-snug">
                                私たちは、<span className="text-[#FF0000] font-bold">マーケット至上主義</span>を掲げ、<span className="text-[#FF0000] font-bold">チーム構築型</span>で一つ一つの取り組みにおいて、効率的で現代的な手法を追求します。「<span className="text-[#FF0000] font-bold">リスクの可視化</span>」を行い、積極的にリスクを受け入れることでリターンを追求し、未知の領域にも果敢に挑戦します。<br /><span className="text-[#FF0000] font-bold">モダン開発の最先端</span>を行くことで、お客様に真に価値のある革新を提供することに私たちは全力を尽くします。
                                </div>
                            </div>
                        </div>
                    </div>
