        ...
        <div className="w-full md:max-w-[1320px] max-w-[540px] mx-auto">
            ...
            <div ref={animateRefs} className="opacity-0 max-w-[546px] md:w-[546px] mx-auto mt-8">
                <div className="flex justify-center items-center gap-3 md:gap-8 mb-[-15px] md:mb-[-20px]">
                    ...
                    <p className="text-center md:text-[24px] text-[17px] font-bold">NFTの受け取りに必要なもの</p>
                    <span className="flex-1 w-full h-[5px] md:h-[7px] bg-[#0055A3] md:rounded-3xl rounded-2xl"></span>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-y-8 md:gap-y-[60px] gap-x-5 md:gap-x-[70px] w-full md:max-w-[690px] max-w-[310px] mx-auto my-8 md:my-14">
                ...
                >
                    <div className="md:min-h-[520px] min-h-[430px] flex flex-col items-center justify-end">
                        <div className="flex-1 flex flex-col items-center justify-center gap-8">
                            <figure>
                                <img className="max-md:max-w-[136px]" src="/images/receive-02.png" alt="" />
                            </figure>
                        </div>
                        <div className="h-[110px] md:px-2">
                            <p className="text-center text-[16px] font-medium">DIVER Tag専用アプリを起動し<br />RWA Tagシールを読み取る</p>
                        </div>
                    </div>
                </Step>
                <Step 
                ...
                >
                    <div className="md:min-h-[520px] min-h-[430px] flex flex-col items-center justify-end">
                        <div className="flex-1 flex flex-col items-center justify-center gap-8">
                            <figure>
                                <img className="max-md:max-w-[136px]" src="/images/receive-03.png" alt="" />
                            </figure>
                        </div>
                        <div className="h-[120px] md:px-2">
                            <p className="text-[16px] font-medium leading-tight">
                            アプリの操作に従いNFTを取得、DIVER Walletのアドレスを入力して転送する。<br />
                            <span className="text-[14px]">※アドレスがDIVER Time Networkのものであることを確認してください。</span>
                            </p>
                        </div>
                    </div>
                </Step>
                ...
                >
                    <div className="md:min-h-[520px] min-h-[430px] flex flex-col items-center justify-end">
                        <div className="flex-1 flex flex-col items-center justify-center gap-8">
                            <figure>
                                <img className="max-md:max-w-[136px]" src="/images/receive-04.png" alt="" />
                            </figure>
                        </div>
                        <div className="h-[100px] md:h-[120px] md:px-2">
                            <p className="text-center text-[16px] font-medium">
                                DIVER WalletでNFTの<br />受領を確認する
                            </p>
                        </div>
                    </div>
                </Step>
