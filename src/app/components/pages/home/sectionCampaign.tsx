...
export default function SectionCampaign() {
  ...
  return (
    <section className="pt-[30px] relative">
      ...
      <div ref={animateRefs} className="opacity-0 w-full max-w-[400px] md:max-w-[960px] mx-auto md:mt-10 mt-16 px-5">
        ...
        <div className="text-center md:text-[100px] text-[45px] font-bold leading-none tracking-widest"><span className="md:text-[155px] text-[64px] font-black">200</span>枚つくる</div>
        <p className="text-center md:text-[20px] text-[14px] font-bold mt-2 tracking-widest">※名刺情報のフォーム入力が必要です</p>
        <div className="flex justify-center max-md:flex-col md:gap-[38px] gap-5 mt-10 md:mt-[95px]">
            <a href="/" className="w-full h-[60px] md:w-[371px] md:h-[75px] flex items-center justify-center border-[3px] border-black bg-[#F4EA00] rounded-[44px] md:text-[24px] text-[16px] font-bold gap-2.5 tracking-[0.3em]">
                <span>名刺作成こちら</span>
            ...
            <a href="/" className="w-full h-[60px] md:w-[345px] md:h-[75px] flex items-center justify-center border-[3px] border-[#22ABF3] bg-white text-[#22ABF3] rounded-[44px] md:text-[22px] text-[16px] font-bold gap-2.5">
                <span>作成・受取り方法を見る</span>
            </a>
        </div>
        <div className="flex justify-center my-8">
            <img className="max-md:w-[80px]" src="/images/image-arrow.png" alt="" />
        </div>
        <div className="flex max-md:flex-col md:gap-[60px] gap-8">
            <div className="md:w-1/2 md:border-[6px] border-[3px] border-[#22ABF3] bg-white p-8 rounded-[30px]">
                <p className="md:text-[36px] text-[24px] font-bold py-5 md:py-10 border-b border-[#22ABF3]">200枚以上必要な方へ</p>
            ...
            <div className="md:w-1/2 bg-[#00B900] flex flex-col items-center py-5 justify-center rounded-[20px]">
                <div className="flex justify-center">
                    <p className="text-white font-dela md:text-[32px] text-[24px] border-b border-white md:pb-3 pb-1.5">次世代サポート</p>
                </div>
                <figure className="pt-3 md:pt-5">
                    <img src="/images/girl.png" alt="" />
                </figure>
                <p className="text-white md:text-[18px] text-[16px] py-4">わからないことはLINEで<br />何でもお問い合わせください。</p>
