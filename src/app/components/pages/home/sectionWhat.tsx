...
export default function SectionWhat() {
  ...
  return (
    <section className="pt-[30px] relative pb-[100px] md:pb-[200px]">
      ...
      <div ref={animateRefs} className="opacity-0 w-full max-w-[1400px] mx-auto flex max-md:flex-col-reverse items-center md:items-end xl:mt-[-110px] mt-[-60px] max-md:gap-10 relative px-5">
        <div className="border-2 border-[#22ABF3] rounded-[40px] max-w-[685px] md:min-h-[235px] mb-3 flex-1 pb-5">
            <div className="flex justify-center -mt-6">
                <h5 className="md:text-[24px] text-[16px] font-bold px-10 py-[7px] bg-[#B1DDFC] tracking-widest rounded-[10px]">ご存知でしたか!?</h5>
            </div>
        ...
        <figure className="flex justify-center flex-1">
            <img className="max-md:max-w-[280px]" src="/images/image-world.png" alt="" />
        </figure>
      </div>
    </section>
  );
