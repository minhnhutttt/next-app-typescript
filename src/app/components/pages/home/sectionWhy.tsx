  ...
  return (
    <div className="bg-white scale-[0.6] w-[300px] h-[600px] max-md:aspect-[380/545] md:h-[700px] md:w-full md:max-w-[400px] rounded-[40px] px-5 md:px-4 pt-5 md:pt-10 flex flex-col items-center justify-start border-8 border-[#3F3F3F]">
      ...
      <div className="flex justify-center mt-6">
        <p className="md:text-[16px] text-[13px] font-bold border-b border-black pb-1">
          ワンポイント解説
        </p>
      </div>
        ...
        <div className="overflow-hidden relative">
          <div className="w-full max-w-[1324px] mx-auto px-5 mt-6 md:mt-12">
            <div className="relative w-[300px] h-[600px] md:w-[400px] md:h-[705px] mx-auto [perspective:1000px]">
              <button
                className="h-full w-[10vw] md:w-[200px] z-10 absolute top-1/2 -translate-y-1/2 flex justify-center items-center right-[-12%] md:right-[-260px]"
                onClick={() => rotate("n")}
              >
                <svg
                  className="-rotate-90"
              ...
              <button
                className="h-full w-[10vw] md:w-[200px] z-10 absolute top-1/2 -translate-y-1/2 flex justify-center items-center left-[-12%] md:left-[-260px]"
                onClick={() => rotate("p")}
              >
                <svg
                  className="rotate-90"
