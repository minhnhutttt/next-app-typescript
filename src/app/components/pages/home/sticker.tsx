...
export default function Sticker() {
  ...
  return (
    <section className="px-5 bg-[url('/images/bg-sticker.png')] bg-[#18539E] bg-cover py-8 md:py-[60px]">
        <div ref={animateRefs} className="opacity-0 w-full max-w-[567px] mx-auto flex items-center max-md:flex-col gap-6 md:gap-8">
            <div className="text-white font-bold font-roboto text-center md:text-[32px] text-[26px] whitespace-nowrap">
                RWA Tagシール <br />購入サイト
            </div>
            <div className="flex flex-col items-center justify-center">
                <figure>
                    <img className="max-md:w-[240px]" src="/images/logo-ddd.png" alt="" />
                </figure>
                <div className="w-full flex justify-center h-[80px] md:h-[75px] mt-5 md:mt-7">
                    <button type="button" onClick={openModal} className="w-[280px] md:w-[311px] h-[60px] md:h-[70px] gap-2 relative rounded-[35px] md:text-[18px] text-[16px] text-[#0055A3] font-black font-noto bg-white flex items-center justify-center hover:border-b border-[#002451] hover:mt-[6px] hover:shadow-none duration-200 [box-shadow:0px_5px_0px_0px_#002451]">
                        <figure>
        ...
        <div className={`z-50 inset-0 fixed pointer-events-none flex justify-center items-center opacity-0 ${isModalOpen ? "pointer-events-auto opacity-100" : ""}`}>
            <div className="absolute inset-0 blur-[8px] bg-[#344054]/[0.7]" onClick={() => closeModal()}></div>
