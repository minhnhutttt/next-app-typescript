...
function UseItem({ title, children }: UseItemPropsType) {
  ...
  return (
    <div
      ref={animateRefs}
      className="opacity-0 w-[300px] md:min-h-[170px] min-h-[140px] bg-[#F7F3F3] rounded-[20px] p-5 [box-shadow:4px_4px_30px_0px_rgba(0,_0,_0,_0.25)]"
    >
      <div className="flex justify-center items-start md:h-[60px] h-[50px]">
        <p className="md:text-[22px] text-[16px] font-bold border-b-[6px] border-[#FE4848] text-center leading-[1.1] pb-1">
          {title}
        </p>
      </div>
...
export default function Use() {
  ...
  return (
    <section id="organization" className="md:mb-[160px] mb-20">
      ...
      <div ref={animateRefs} className="opacity-0 px-3">
        <div className="flex justify-center relative mt-6">
          ...
          <div className="absolute top-2 md:top-[16px] md:text-[28px] lg:text-[36px] text-[24px] font-medium text-center">
            ...
            <p className="md:text-[32px] text-[20px] max-md:mt-2 font-medium tracking-[0.08em]">
              まずは気軽にチャットで相談！
            </p>
          </div>
        </div>
