...
export default function ServiceTitle() {
  ...
  return (
    <div ref={animateRefs} className="overflow-hidden relative h-[423px] flex items-center justify-center mb-[90px] mt-[135px]">
        <div  className="absolute inset-x-0 top-[-200px] z-10"><ServiceBackground /></div>
