...
const Present = () => {
  ...
  return (
    <section ref={ref} className="pt-[70px] relative md:pt-[120px] md:pb-[78px] pb-[50px] overflow-hidden">
        <div className="relative">
            ...
            <div className="relative">
                ...
                <div className="fade-up flex justify-center md:mt-10">
                    <a className="flex items-center justify-center md:w-[360px] w-[200px] h-[44px] md:h-[80px] rounded-[50px] bg-[#101010] md:text-[24px] text-[15px] font-black text-[#7FFF00] outline-1 outline outline-[#7FFF00] md:outline-offset-[-5px] outline-offset-[-3px] [box-shadow:0px_0px_30px_0px_rgba(127,_255,_0,_0.30)] gap-2 tracking-[0.15em] md:tracking-[0.3em] duration-300 hover:opacity-75" href="/form">
                        <span>今すぐGET</span>
