            ...
            <div className="">
                ...
                <div className="fade-up gradient border border-[#E0C3FC] rounded-[20px] md:mt-[77px] mt-[50px] pt-8 md:pt-10 md:pb-[62px] pb-10 px-6">
                    ...
                    <div className="flex justify-center md:gap-[26px] gap-5 md:mt-[26px] mt-5 max-md:flex-col max-md:items-center">
                        <a href="/" className="flex items-center justify-center md:w-[270px] w-[240px] h-16 md:h-20 bg-[#2E8DEC] [box-shadow:0px_0px_40px_0px_rgba(100,_0,_136,_0.20)] border border-white rounded-[70px] md:text-[16px] text-[14px] font-bold text-white gap-2 duration-150 hover:opacity-75">
                            <figure>
                        ...
                        <a href="/" className="flex items-center justify-center md:w-[270px] w-[240px] h-16 md:h-20 bg-[#C985FF] [box-shadow:0px_0px_40px_0px_rgba(100,_0,_136,_0.20)] border border-white rounded-[70px] md:text-[16px] text-[14px] font-bold text-white gap-2 duration-150 hover:opacity-75">
                            <figure>
