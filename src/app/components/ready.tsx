      ...
      <div className="w-full max-w-[1320px] mx-auto">
        ...
        <div className="fade-up grid max-md:max-w-[400px] max-md:mx-auto md:grid-cols-3 mt-10 md:mt-28 gap-5 md:gap-[30px]">
          <div className="bg-white rounded-[40px] lg:p-10 p-5">
            <figure>
              <img className="max-md:w-[90px]" src="/images/ready-01.png" alt="" />
            </figure>
          ...
          <div className="bg-white rounded-[40px] lg:p-10 p-5">
            <figure>
              <img className="max-md:w-[90px]" src="/images/ready-02.png" alt="" />
            </figure>
            <h6 className="lg:text-[32px] md:text-[22px] text-[18px] font-bold mt-2 md:mt-3">
          ...
          <div className="bg-white rounded-[40px] lg:p-10 p-5">
            <figure>
              <img className="max-md:w-[90px]" src="/images/ready-03.png" alt="" />
            </figure>
            <h6 className="lg:text-[32px] md:text-[22px] text-[18px] font-bold mt-2 md:mt-3">
              名刺情報
            </h6>
        ...
        <div className="fade-up flex justify-center mt-10 md:mt-14">
            <a className="flex items-center justify-center md:w-[360px] w-[200px] h-[44px] md:h-[80px] rounded-[50px] bg-[#7FFF00] md:text-[24px] text-[15px] font-black text-[#000] outline-1 outline outline-[#000] md:outline-offset-[-5px] outline-offset-[-3px] [box-shadow:0px_0px_30px_0px_rgba(127,_255,_0,_0.30)] gap-2 tracking-[0.15em] md:tracking-[0.3em] duration-300 hover:opacity-75" href="/form">
                <span>今すぐGET</span>
                <svg className="max-md:w-5" xmlns="http://www.w3.org/2000/svg" width="37" height="12" viewBox="0 0 37 12" fill="none">
                    <path d="M1 10.1543H35.7254M28 1.84563L35.9791 9.82522" stroke="black" strokeWidth="2" strokeLinecap="round"/>
                </svg>
            </a>
        </div>
      </div>
