...
const SectionComparison = () => {
  ...
  return (
    <section className="bg-[url('/images/bg-01.png')] bg-cover px-5 md:pt-16">
        <div className="w-full max-w-[1200px] mx-auto flex items-center md:gap-[60px] gap-8">
            <p className="">
        ...
        <div className="pr-[15%]">
            <div className="bg-[#E3BF3C]/[0.98] bg-[url('/images/bg-sec-01.png')] bg-cover">
                <div className="flex">
                    <div className="flex flex-col items-center justify-center">
                        <figure>
                            <img src="/images/img-sec-01-01.png" alt="" />
                        </figure>
                        <div className="mt-3 md:mt-6">
                            <h5 className="font-hiragino md:text-[26px] text-[16px] font-semibold">
                                100種以上の干し芋を比較！<br />
                                辿り着いたサッパリした甘み！
                            </h5>
                            <p className="">
                                日本中を1年間探し、茨城県だけでも100種類以上比較しました。そして自慢のサッパリした甘みの「至高の干し芋」に行きつきました。
                            </p>
                        </div>
                    </div>
                </div>
