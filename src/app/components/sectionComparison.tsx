...
const SectionComparison = () => {
  ...
  return (
    <section className="bg-[url('/images/bg-01.png')] bg-cover max-md:bg-bottom pt-8 md:pt-16 pb-40 md:pb-[510px]">
        <div className="w-full md:max-w-[1240px] max-w-[440px] mx-auto flex max-md:justify-center items-center md:gap-[60px] gap-5 px-5 pb-5 md:pb-8">
            ...
            <h5 className="font-hiragino md:text-[30px] text-[18px] font-semibold">比較の末の「至高」のほしいも</h5>
        </div>
        <div className="md:pr-[15%] max-md:px-5">
            <div className="bg-[#E3BF3C]/[0.98] bg-[url('/images/bg-sec-01.png')] bg-cover px-5 md:px-[2vw] border-white border-2 md:border-l-0 pt-8 md:pb-14 md:pt-12 relative max-md:max-w-[440px] max-md:mx-auto">
                ...
                <div className="md:absolute left-full bottom-0 font-hiragino md:text-[58px] text-[30px] text-white font-semibold md:[writing-mode:vertical-rl] md:[text-orientation:mixed] md:rotate-180">Characteristics</div>
            </div>
        </div>
    </section>
  );
