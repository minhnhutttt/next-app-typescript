...
const data = [
    ...
    text: (
      <>
        <span className="bg-[linear-gradient(to_top,_#8EC5FC_30%,_transparent_30%)]">
          沖縄県宮古島の美しい自然に囲まれた「KARIMATA(狩俣)供養所」。
        </span>
        青い海と白い砂浜、そよ風が運ぶハイビスカスの香り。その静謐な空間に佇む供養所は、まるでペットたちに安らぎを与えているかのようです。ここで過ごす時間は、愛するペットへの感謝の気持ちを捧げる大切なひとときとなるでしょう。
      </>
    ),
    quote: (
      <>
  ...
  },
  {
    ...
    text: (
      <>
        画面の中に映し出されるペットの姿や鳴き声は、まるで本当にそこにいるかのよう。ペットとの楽しい会話、一緒に過ごした部屋、思い出のおもちゃなど、大切な瞬間がデジタルの世界で鮮やかによみがえります。
        <span className="bg-[linear-gradient(to_top,_#8EC5FC_30%,_transparent_30%)]">
          メタバースでのペットとの再会は、悲しみを癒し、絆を確かめ合う特別な体験と
        </span>
        なるでしょう。そして同時に、
        <span className="bg-[linear-gradient(to_top,_#8EC5FC_30%,_transparent_30%)]">
          ペットを失った現実と向き合い、そのロスを受け止める大切なプロセスで
        </span>
        もあるのです。
      </>
    ),
    quote: (
      <>
        メタバース上のあの子は、リアルに再現されていて驚きました。でも、それはデジタルの世界のあの子。現実のあの子はもういないという事実と、メタバースでは改めて向き合うことになります。悲しみを感じつつも、
        <span className="bg-[linear-gradient(to_top,_#8EC5FC_30%,_transparent_30%)]">
          あの子との“おもいで”の風化を止め、メタバースを通じて心の中で生き続けさせる
        </span>
        大切さを実感しました。
      </>
    ),
  ...
  },
  {
    ...
    text: (
      <>
        メタバース空間には、3Dデータ化された思い出のアイテムを自由に展示できる機能も。ペットが愛用していたおもちゃや首輪、写真など、あの子との大切な思い出の品々を、美しく飾ることができます。それらは
        <span className="bg-[linear-gradient(to_top,_#8EC5FC_30%,_transparent_30%)]">
          ペットとの絆を象徴する大切な宝物。“おもいで”の品を通して、ペットとの絆を永遠のものに
        </span>
        していく助けとなるでしょう。
      </>
    ),
    quote: (
      <>
        亡くなったペットの思い出の品を、デジタルの形で残せるのは本当に嬉しい。メタバースに飾られたあの子のお気に入りのおもちゃを見ていると、今でも一緒に過ごしているような、不思議な感覚に包まれるんです。
        <span className="bg-[linear-gradient(to_top,_#8EC5FC_30%,_transparent_30%)]">
          あの子はもういないけれど、こうして思い出の品を通して、あの子との絆を感じることができる。
        </span>
        それが、ペットロスを乗り越える原動力になっているんだと思います。
      </>
    ),
    sign: "(40代女性)",
  },
  {
    ...
    text: (
      <>
        『メタでペット供養』では、AI僧侶による厳かな読経も行われます。故人を弔う際と同じように、ペットのために心を込めて供養を捧げる姿に、深い安らぎを覚えずにはいられません。定期的な法要は、
        <span className="bg-[linear-gradient(to_top,_#8EC5FC_30%,_transparent_30%)]">
          ペットの死を受け止め、前に進む力を与えてくれます。ペットとの再会を喜ぶ一方で、死と向き合う
        </span>
        ことの大切さを教えてくれるのです。
      </>
    ),
    quote: (
      <>
        AI僧侶の読経は、自然で荘厳。読経の音色に、あいつも喜んでいるような気がして…。でも、
        <span className="bg-[linear-gradient(to_top,_#8EC5FC_30%,_transparent_30%)]">
          読経はあいつが亡くなったという現実も突きつ
        </span>
        けてくる。その現実と向き合うたびに、あいつ
        <span className="bg-[linear-gradient(to_top,_#8EC5FC_30%,_transparent_30%)]">
          との絆はより深く、強いものになっていくん
        </span>
        です。
      </>
    ),
            ...
            >
              <div className="relative">
                <div className="splide__arrows md:absolute right-0 md:top-[-135px] flex gap-4 md:w-[254px] w-[140px] justify-center max-md:ml-auto max-md:mb-6">
                  <button className=" splide__arrow--prev hover:opacity-75 duration-150">
                    <img
                  ...
                  <button className=" splide__arrow--next hover:opacity-75 duration-150">
                    <img
                      className="max-md:w-12"
                    ...
                    <SplideSlide key={index}>
                      <div className="md:w-[460px] w-[320px] md:h-[883px] h-[800px] bg-white rounded-[10px] [box-shadow:0px_0px_50px_0px_rgba(142,_197,_252,_0.40)] mr-4 md:mr-[30px]">
                        ...
                        <div className="md:mt-[23px] mt-4 px-7">
                          <h5 className="md:text-[18px] text-[16px] font-bold text-gradient-01 flex items-center gap-[5px]">
        ...
        <div className="w-full max-w-[1141px] mx-auto xl:pt-[90px] pt-8 relative md:pb-12 pb-4">
          <span className="xl:absolute top-12 left-[50px] w-[109px]">
            <img
              ...
              src="/assets/images/slider-animal-01.png"
              alt=""
            />
          </span>
          <div className="w-full max-w-[800px] mx-auto md:bg-[url('/assets/images/line.png')] bg-[url('/assets/images/line-sp.png')] bg-repeat-y bg-bottom">
            <p className="md:text-[20px] text-[16px] font-medium md:leading-[2.7] leading-[2.2]">
              『メタでペット供養』は、ペットとの再会の喜びと死への向き合いのバランスを大切にしています。そのどちらもが、ペットとの真の絆を育む上で欠かせない要素だと考えているからです。
              <br />
              ペットロスに悩む方々に寄り添い、家族同然のペットとの絆を永遠に大切にする。それが、私たちの使命です。もしあなた様が、愛するペットとの絆を、新たな形で紡ぎなおしたいと願うのなら、
              <br />
              ぜひ「メタでペット供養」をご利用ください。
            </p>
          </div>
