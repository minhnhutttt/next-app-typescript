...
const Tooltip = ({ text, tooltipTitle, position = "bottom", children }: TooltipProps) => {
    ...
    >
      ...
      {showTooltip && (
        <>
          ...
          <span
            className={`fixed md:absolute bg-[#6A6767]/[0.95] text-white text-sm md:px-[2vw] px-[5vw] md:py-[1vw] py-[5vw] max-md:top-1/2 max-md:-translate-x-1/2 left-1/2 max-md:-translate-y-1/2 ${positionClass} rounded-3xl flex flex-col items-center justify-center md:w-[24vw] w-[75vw] z-50`}
          >
