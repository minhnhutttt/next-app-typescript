...
const Tracouhunter = () => {
  ...
  return (
    <section ref={ref} className="relative md:py-[60px] py-[40px] bg-[url('/assets/images/bg-tracou.png')] bg-cover">
        <div className="w-full md:max-w-[1440px] max-w-[440px] mx-auto">
            ...
            <div className="flex md:items-end mt-5 max-md:flex-col-reverse">
                <div className="flex-1 md:pb-[7.292vw] dt:pb-[105px] px-5 max-md:pt-10">
                ...
                <figure className="max-md:w-full max-dt:w-[63.403vw]">
