    ...
    <section ref={ref} className="md:-mt-[72px] -mt-4 border-t border-black ">
        <div className="absolute flex justify-center items-center left-1/2 -translate-x-1/2 z-10 md:pt-16 pt-4">
                    <div className="flex flex-col justify-center md:gap-[50px] gap-6 relative">
                        <div className="bottom-[-4.444vw] dt:bottom-[-64px] md:left-[-7.292vw] left-[-5.292vw] dt:-left-[105px] absolute bg-[url('/assets/images/bg-our-vision.png')] aspect-[610/345] bg-cover w-[54vw] md:w-[42.361vw] dt:w-[610px]">
                        </div>
        ...
        <div className="flex">
            <div className="md:bg-[url('/assets/images/bg-main.png')] bg-[url('/assets/images/bg-main-sp.png')] w-full lg:aspect-[1336/892] min-h-[550px] bg-cover bg-no-repeat">
                ...
                <div className="md:w-1/2 lg:pl-14 pl-5 md:pl-20 pr-5">
                    <div className="font-serif font-medium text-center">
                        <h2 className="lg:text-[25px] text-[15px]">世界に向けて、唯一無二の銘酒を作ります</h2>
                        <p className="md:text-[18px] text-[13px]">Inebriate the World with Japan&apos;s Best Sake Yet Unseen</p>
                    </div>
                </div>
                </div>
            </div>
            <div className="md:flex-[0_0_105px] flex-[0_0_40px] bg-white flex justify-center items-start pt-[124px]">
                <img className="max-md:w-3" src="/assets/images/text-seke.png" alt="" />
            </div>
        </div>
