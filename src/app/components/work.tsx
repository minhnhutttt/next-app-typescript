    ...
    <section id="workstyle" className="relative pt-[65px] px-6">
      ...
      <div className="w-full max-w-[1277px] mx-auto">
        <div
          id="diver-wallet"
          data-scroll
          className="ani-fade-up gradient-border1 bg-[#FFCB71] rounded-[47px] border-[5px]  pt-[20px] pb-[30px] mb-[60px] md:px-[56px] px-4"
        >
          ...
          <div className="w-full max-w-[640px] md:mt-[60px] mt-[30px] flex justify-center items-center md:gap-10 gap-6 max-md:flex-col mx-auto">
            <a
