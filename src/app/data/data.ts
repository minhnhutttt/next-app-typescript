export interface ArticleData {
  ...
  export const getArticleByIdAndLang = (data: ArticleData[], id: string, lang: string): ArticleData | undefined => {
    return data.find(article => article.id === id && article.lang === lang);
  };
  ...
  export const getAllArticleIds = (data: ArticleData[]): string[] => {
    const ids = new Set(data.map(article => article.id));
