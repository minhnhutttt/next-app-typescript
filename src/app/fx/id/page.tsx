...
export default function FxSingle() {
        ...
        <div className="flex">
            ...
            <div className="max-xl:hidden w-[295px] bg-[#D7E7CD] dark:bg-[#4D7F64]/[0.68] border-l border-[#358D93] dark:border-white flex flex-col justify-between">
                <div className="fade-up px-3 pt-6">
                    ...
                    <div className="w-[272px] mx-auto dark:text-white bg-white/70 dark:bg-white/30 border border-[#3B869D]/[0.7] dark:border-[#4D7F64]/[0.7] p-2.5">
                        <p className="md:text-[13px] text-[15px] border-b border-[#199BC3] dark:border-white pb-1 font-semibold">イーロンマスク</p>
                    ...
                    <div className="flex justify-end mt-[680px]">
                        <LogoDots color="fill-[#3EB07A]" darkColor="dark:fill-[#CAF2A1]" />
                    </div>
                </div>
            </div>
            
            <div className="h-[324px] flex justify-end items-end p-3 absolute bottom-0 right-0">
                <BarCode  color="fill-[#5BBB8B]" darkColor="dark:fill-[#CAF2A1]"  />
            </div>
            <Modal isOpen={isModalOpen} onClose={closeModal}>
            <div className="w-[300px] md:w-[500px] mx-auto dark:text-white bg-white dark:bg-[#666666] border border-[#3B869D]/[0.7] dark:border-[#4D7F64 ]/[0.7] p-2.5">
                        <p className="md:text-[17px] text-[15px] font-semibold border-b border-[#199BC3] dark:border-white pb-1">イーロンマスク</p>
