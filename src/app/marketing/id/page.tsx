...
export default function MarketingSingle() {
        ...
        <div className="flex">
            ...
            <div className="max-xl:hidden w-[295px] bg-[#C8E8E1] dark:bg-[#507F8E]/[0.68] border-l border-[#358D93] dark:border-white flex flex-col justify-between">
                <div className="fade-up px-3 pt-6 sticky top-0">
                    ...
                    <div className="w-[272px] mx-auto dark:text-white bg-white/70 dark:bg-white/30 border border-[#358D93]/[0.7] dark:border-[#507F8E]/[0.7] p-2.5">
            ...
            <div className="w-[300px] md:w-[500px] mx-auto dark:text-white bg-white dark:bg-[#666666] border border-[#358D93]/[0.7] dark:border-[#507F8E]/[0.7] p-2.5">
