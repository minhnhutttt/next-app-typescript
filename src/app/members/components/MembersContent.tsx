            ...
            <span className="absolute md:w-[432px] w-[200px] aspect-[432/427] bg-[url(/assets/images/member-star.png)] bg-no-repeat [background-size:100%_100%] pointer-events-none animate-[bounceRandomly3_80s_linear_infinite]"></span>
              ...
              <div className="lg:max-w-[478px] ">
                ...
                >
                  ...
                  Assistant to the President and Music Production Manager
                  (Manager level) <br />
                  Avex China Co., Ltd. <br />
                  Engaged in A&R, production, management, and promotion planning
                  for Avex China's first signed artist, Jiang Yiyan
                  <br />
                  <br />
                  February 2011 – March 2011 <br />
                  Content Development Division <br />
                  Amuse Inc. <br />
                  Handled all preparatory work for the establishment of a local
                  ...
                  Oversaw operations and served as executive producer for the
                  discovery, training, and debut of the company’s first local
                  artist
                  <br />
                  <br />
                  January 2017 – Present <br />
                  Freelance <br />
                  Engaged in consulting for Japanese companies in Taiwan, as
                  well as irregular casting work for major Japanese advertising
                  agencies’ commercials <br />
                  Returned to Japan in March 2018 and has since been involved in
                  launching startups, casting, and commissioned work from idol
                  management companies <br />
                  From June 2021 to December 2022, contracted (as full-time
                  equivalent) by Doyuen Holdings Co., Ltd. to work on regional
            ...
            <span className="absolute md:w-[432px] w-[200px] aspect-[432/427] bg-[url(/assets/images/member-star.png)] bg-no-repeat [background-size:100%_100%] pointer-events-none animate-[bounceRandomly4_80s_linear_infinite]"></span>
              ...
              <div className="lg:max-w-[478px] ">
                <p data-scroll className="md:text-[14px] text-[12px] leading-[1.4]">
                  ...
                  group and film production. <br />
                  <br />
                  Specialties: corporate finance, business strategy formulation,
