...
const Benefits = () => {
  ...
  return (
    <section ref={ref} className="relative md:mt-24 mt-14 px-5">
        <div className="fade-up w-full md:max-w-[1300px] max-w-[440px] mx-auto  bg-[linear-gradient(116deg,_#A1DA29_-23.69%,_#47A40F_116.67%)] md:rounded-[61px] rounded-[40px] border-2 border-[#8EC21D]">
            <div className="md:h-[134px] flex items-end items-center justify-between">
                <div className="w-[60px] md:w-[202px] -ml-2">
                ...
                <div className="text-white md:h-[134px] flex flex-col justify-center max-md:py-2">
                    ...
                    <p className="lg:text-[25px] md:text-[18px] text-[14px] font-extrabold max-md:hidden">ご要望が多かった犬や猫以外の様々なペットもご対応可能になりました！</p>
                </div>
                <div className="md:w-[297px] w-[100px] md:-mr-5 md:-mb-6 relative z-10">
            ...
            <div className="bg-[linear-gradient(180deg,_#FAFFD9_0%,_#F5FAB9_100%)] flex items-center gap-[30px] px-7 py-6 md:rounded-b-[61px] rounded-b-[40px] relative max-md:flex-col">
                <figure className="max-md:w-auto max-lg:w-3/12 max-md:hidden">
                    <img className="max-md:w-[180px]" src="/assets/images/price/animal-03.png" alt="" />
                </figure>
                <div className="">
                    <p className="lg:text-[25px] md:text-[18px] text-[14px] font-extrabold md:hidden mb-6">ご要望が多かった犬や猫以外の様々なペットもご対応可能になりました！</p>
                    <figure className="md:hidden border-b border-black/50 pb-6">
