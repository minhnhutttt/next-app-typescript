  const Goen = () => {
    return (
      <section className="overflow-hidden md:pt-[70px] pt-[100px] text-[#333] bg-[url('/assets/images/bg-goen.png')] bg-cover">
        <div className="bg-[url('/assets/images/goan-title.png')] bg-cover bg-center md:h-[521px] h-[300px] flex justify-center md:pt-[140px] pt-[80px]">
            <p className="text-center text-gradient-03 md:text-[36px] text-[22px] font-bold tracking-widest">
        ...
        <div className="px-5 md:-mt-[70px] -mt-[40px]">
            <div className="w-full md:max-w-[1270px] max-w-[540px] mx-auto md:bg-[url('/assets/images/frame-goen.png')] bg-[url('/assets/images/frame-goen-sp.png')] bg-[length:100%_100%] md:pt-[80px] pt-12 px-6 md:pb-[130px] pb-20">
                <div className="flex items-center gap-7 w-full max-w-[1040px] mx-auto  max-md:flex-col">
                    <figure>
                ...
                <div className="w-full max-w-[1110px] mx-auto flex md:mt-20 mt-10 gap-10 max-md:flex-col-reverse max-md:items-center">
                    ...
                    <figure className="max-md:w-auto max-lg:w-[30%]">
            ...
            <div className="flex justify-center items-center flex-col">
                <p className="md:text-[18px] text-[14px] font-black text-center [filter:drop-shadow(0px_4px_4px_rgba(0,_0,_0,_0.25))]">
                ...
                <a href="/" className="flex items-center justify-center md:w-[500px] w-[320px] h-20 md:h-[114px] gradient-03 [box-shadow:0px_0px_40px_0px_rgba(100,_0,_136,_0.20)] border border-white rounded-[70px] md:text-[22px] text-[17px] font-bold text-white gap-3">
                            <figure>
