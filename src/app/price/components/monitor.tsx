...
const Monitor = () => {
    return (
      <section className="overflow-hidden pt-14 md:pt-[100px]">
        <div className="w-full max-w-[1440px] mx-auto">
          <div className="w-full max-w-[996px] mx-auto flex items-center gap-3 md:gap-10 px-5">
            <span className="flex-1 h-px gradient-03"></span>
            <span className="md:text-[24px] text-[18px] text-gradient-03 text-center">
            ご縁があって今このページを<br className="md:hidden" />ご覧いただいているあなた様に贈る
            </span>
            <span className="flex-1 h-px gradient-03"></span>
          </div>
          <h4 className="text-center lg:text-[48px] md:text-[32px] text-[24px] font-medium mt-5 leading-[1.7]">
        ...
        <div className="flex items-center md:gap-[56px] gap-[32px] md:mt-14 mt-8 max-md:flex-col">
            ...
            <div className="md:text-[20px] text-[16px] font-medium flex-1 max-md:pl-5 pr-5">
                <p className="max-w-[500px]">
                    愛するペットとの絆を新たなカタチで紡ぎなおしたいとあなた様が願うなら、
                    <br /><br />
                    <span className="text-gradient-03 md:text-[32px] text-[20px]">今こそ、その一歩を踏み出すとき</span>
                    <br />
                    <br />
                    です。
                    <br />
