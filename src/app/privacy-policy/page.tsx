      ...
      <section className="mb-[256px] max-md:mb-[82px]">
        <div className="container">
          <div className="max-w-[600px] mx-auto mb-[128px]">
            <div className="text-center text-[32px] font-bold mb-[24px]">プライバシーポリシー</div>
            <div className="text-right text-[24px] mb-[24px]">
              制定　2024.7.1 <br />
              TECHNO合同会社
            </div>
            ...
            <h2 className="text-[24px] mb-[24px]">
              1. 取得する個人情報の項目
            </h2>
            <div className="mb-[24px]">
            ...
            （1）当社は、次に掲げる場合を除き、当社が取り扱う個人情報を、あらかじめお客様の同意を得ないで、第三者に提供いたしません。<br />
              ...
              （2）上記（1）にかかわらず、当社は、次に掲げる場合には、当社が取り扱う個人情報を第三者に提供することがあります。 <br />
              1 お客様の興味・関心等に合わせた広告の配信及びその成果確認並びにサービスの提供のために、それ自体では特定の個人を識別できないようにした情報を当社と提携している広告配信事業者に提供する場合<br />
              ...
              <ol className="list-decimal ml-8">
                ...
                <a href="https://leginfo.legislature.ca.gov/faces/codes_displayText.xhtml?lawCode=CIV&division=3.&title=1.81.5.&part=4.&chapter=&article=" className="underline" target="_blank">https://leginfo.legislature.ca.gov/faces/codes_displayText.xhtml?lawCode=CIV&division=3.&title=1.81.5.&part=4.&chapter=&article=　</a>
                ・第三者が講ずる個人情報保護措置<br />
            ...
            当社のウェブサイトでは、お客様により適切なサービスをご提供するためCookie（クッキー）その他のトラッキング又は解析を行うための類似技術（以下、総称して「Cookie」といいます。）を使用しております。<br />
              ...
              <br />
              2 第三者が提供する閲覧履歴等の収集・分析サービスの利用について<br />
...
　　住所：〒150-0002　東京都渋谷区渋谷2-19-15宮益坂ビルディング609<br />
