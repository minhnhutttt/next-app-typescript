    ...
    <section>
      ...
      <div className="px-5 mt-7 md:mt-10">
        ...
        <div className="mx-auto pb-16 pt-5 w-full max-w-[1000px] space-y-14 md:pb-20 md:pt-11">
          ...
          <TextBlock>
            <p className="flex">取得する個人情報の項目</p>
            当社は、お客様に関する次に掲げる個人情報を取得します。<br />
            <ol className="list-decimal ml-5">
              <li>本人確認に関する情報<br />氏名、住所、郵便番号、性別、生年月日、電話番号、メールアドレス、アカウントID及びパスワード、SNSアカウント情報、免許証・住民票等の公的証明書に関する情報等</li>
              <li>お取引に関する情報<br />お取引内容及び購入履歴に関する情報等</li>
              <li>決済に関する情報<br />金融機関口座に関する情報、決済及びその方法に関する情報等</li>
              <li>サービスのご利用に際して取得する情報<br />クッキー（Cookie）ID等のオンライン上の識別子、ご利用の端末情報、位置情報、閲覧履歴その他のサービスの利用状況（アクセスログ、IPアドレス、ブラウザ情報、ブラウザの言語設定等を含みます。）</li>
              <li>その他の情報<br />お客様から当社へのお問い合せ・ご連絡等に関する情報等</li>
            </ol>
          </TextBlock>
          ...
          <TextBlock title="安全管理措置">
            当社は、その取り扱う個人情報の漏洩、滅失又は毀損の防止その他個人情報の安全管理のために、必要かつ適切な措置を講じます。当社が講じる安全管理措置については、第１０項記載のお問い合わせ窓口までお問い合わせください。<br />
            開示等の請求<br />
            当社は、次に定めるとおり開示等の請求（利用目的の通知、個人情報又は第三者提供記録の開示、訂正・追加・削除、利用の停止・第三者提供の停止の請求をいいます。）に対応します。<br />
            <ol className="list-decimal ml-5">
              <li>利用目的の通知又は個人情報若しくは第三者提供記録の開示<br />お客様は、当社に対し、下記4に定める手続に従って、個人情報保護法において認められる範囲内において、利用目的の通知を求め、又は、個人情報若しくは第三者提供記録の開示を請求することができます。ただし、当社は、次の各号のいずれかに該当する場合は、開示を行わないことがあります。
                <ul className="list-[lower-alpha] ml-5">
                    <li>開示することでご本人様又は第三者の生命、身体、財産その他の権利利益を書するおそれがある場合</li>
                    <li>開示することで当社の業務の適正な実施に著しい支障を及ぼすおそれがある場合</li>
                    <li>開示することが法令に違反することとなる場合</li>
                    <li>開示の請求がご本人様からであることが確認できない場合</li>
                </ul>
              </li>
              <li>なお、利用目的の通知又は個人情報若しくは第三者提供記録の開示を請求される場合には、下記4に定める開示手数料をいただきます。</li>
              <li>訂正・追加・削除<br />お客様は、下記4に定める手続きに従って、個人情報の訂正・追加・削除を請求することができます。その場合、当社は、利用目的の達成に必要な範囲内で遅滞なく調査を行い、その結果に基づき、個人情報保護法において認められる範囲内において、当該個人情報の訂正・追加・削除を行います。</li>
              <li>利用の停止又は第三者提供の停止<br />お客様は、下記4に定める手続に従って、個人情報の利用の停止又は第三者提供の停止を請求することができます。その場合、当社は、個人情報保護法に従って適切に対応いたします。</li>
              <li>
                手続 <br />
                <br />
                ...
                <ul className="list-[lower-alpha] ml-5">
                  <li>請求書<br />請求書については、末尾の連絡先よりお問い合わせください。</li>
                  <li>本人確認書類<br />
                    ■お客様ご本人による請求の場合<br />
                    ...
                    <ol className="list-decimal ml-5">
                      <li>委任状</li>
                      <li>任意代理人の本人確認書類（個人番号カード（表面）、運転免許証、健康保険被保険者証、又はパスポートの写し（いずれか一つ））</li>
                    </ol>
                  </li>
                  <li>■法定代理人による請求の場合<br />上記の「お客様ご本人による請求の場合」に記載されている書類に加え、下記の書類
                    <ol className="list-decimal ml-5">
                      <li>法定代理権の存在を確認できる書類（戸籍謄本又は成年後見登記事項証明書）</li>
                      <li>法定代理人の本人確認事類 （個人番号カード（表面）、運転免許証、健康保険被保険者証、又はパスポートの写し（いずれか一つ））</li>
                    </ol>
                  </li>
                  <li>
                    送付先<br />
                    〒102-0083<br />
                    住所　東京都新宿区西早稲田2-18-23 スカイエスタ西早稲田 2F <br />
          ...
          <ul className="list-[lower-alpha] ml-5">
            ...
            <li>
              第三者が提供する閲覧履歴等の収集・分析サービスの利用について<br />
