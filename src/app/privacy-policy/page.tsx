    ...
    <PageContainer>
      ...
      <div className="px-5 mt-7 md:mt-10">
        ...
        <div className="mx-auto pb-16 pt-5 w-full max-w-[1000px] space-y-14 md:pb-20 md:pt-11">
          ...
          <TextBlock>
            <p className="flex">
              <span className="mr-1 flex-[0_0_20px] break-keep text-right">1.</span>取得する個人情報の項目
            </p>
...
<p className="flex">
            ...
            ・法定代理人の本人確認書類 （個人番号カード（表面）、運転免許証、健康保険被保険者証、又はパスポートの写し（いずれか一つ））<br />
            ウ　<br />
            送付先<br />
            〒265-0066 <br />
