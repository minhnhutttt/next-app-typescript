...
なお、本ポリシーで使用する用語の意味は、個人情報の保護に関する法律（以下、「個人情報保護法」といいます。）に準拠するものとします。
          ...
          当社は、お客様に関する次に掲げる個人情報を
            ...
            <ol className="list-decimal ml-5">
              ...
              <li>
              決裁に関する情報<br />金融機関口座に関する情報、決済及びその方法に関する情報等
              </li>
              <li>
              サービスのご利用に際して取得する情報
                <br />
          ...
          当社は、次に掲げる場合を除き、当社が取り扱う個人情報を、あらかじめお客様の同意を得ないで、第三者に提供いたしません。
            ...
            上記（1）にかかわらず、当社は、次に掲げる場合には、当社が取り扱う個人情報を第三者に提供することがあります。
          ...
          <TextBlock title="開示等の請求">
            ...
            <ol className="list-decimal ml-5">
              ...
              訂正・追加・削除
                <br />
                お客様は、下記（4）に定める手続きに従って、個人情報の訂正・追加・削除を請求することができます。その場合、当社は、利用目的の達成に必要な範囲内で遅滞なく調査を行い、その結果に基づき、個人情報保護法において認められる範囲内において、当該個人情報の訂正・追加・削除を行います。
              </li>
              <li>
              利用の停止又は第三者提供の停止
                <br />
                ...
                <ul className="list-[lower-alpha] ml-5">
                  ...
                  <li>
                    ...
                    <ol className="list-decimal ml-5">
                      ...
                      <li>
                      法定代理人の本人確認事類 （個人番号カード（表面）、運転免許証、健康保険被保険者証、又はパスポートの写し（いずれか一つ））
                      </li>
                    </ol>
                  </li>
                  <li>
                  送付先
                    ...
                    〒160-0023
                    <br />
                    住所　東京都新宿区西新宿３丁目２−９ 新宿ワシントンビル本館 2F
                    <br />
                    SKALE株式会社　個人情報開示請求窓口
                  </li>
                </ul>
              </li>
            </ol>
          ...
          ご意見、ご質問、苦情のお申出その他個人情報の取扱いに関するお問い合わせは、下記の窓口までご連絡ください。
            <br />
            住所：〒160-0023 東京都新宿区西新宿３丁目２−９ 新宿ワシントンビル本館 2F
            <br />
            E-mail：we@skale.co.jp
          </TextBlock>
        </div>
      </div>
    </section>
