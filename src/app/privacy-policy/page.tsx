    ...
    <main>
      ...
      <section className="mb-[256px] max-md:mb-[82px]">
        <div className="container">
          <div className="mx-auto mb-[128px] max-w-[600px]">
            <div className="mb-[24px] text-center text-[32px] font-bold">
              プライバシーポリシー
            </div>
            ...
            <h2 className="mb-[24px] text-[24px]">1. 取得する個人情報の項目</h2>
            <div className="mb-[24px]">
            ...
            <h2 className="mb-[24px] text-[24px]">2. 利用目的</h2>
            <div className="mb-[24px]">
            ...
            <h2 className="mb-[24px] text-[24px]">3. 第三者提供</h2>
            <div className="mb-[24px]">
            ...
            <h2 className="mb-[24px] text-[24px]">7. Cookie の取扱い</h2>
            <div className="mb-[24px]">
              （1）Cookieの利用について <br />
              ...
              <br />
              2 第三者が提供する閲覧履歴等の収集・分析サービスの利用について
              <br />
