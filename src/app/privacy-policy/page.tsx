        ...
        <div className="mx-auto pb-16 pt-5 w-full max-w-[1000px] space-y-14 md:pb-20 md:pt-11">
          ...
          <TextBlock>
            ...
            <ol className="list-decimal ml-5">
              ...
              <li>決裁に関する情報<br />金融機関口座に関する情報、決済及びその方法に関する情報等</li>
          ...
          <TextBlock title="安全管理措置">
            ...
            <ol className="list-decimal ml-5">
              <li>利用目的の通知又は個人情報若しくは第三者提供記録の開示<br />お客様は、当社に対し、下記4に定める手続に従って、個人情報保護法において認められる範囲内において、利用目的の通知を求め、又は、個人情報若しくは第三者提供記録の開示を請求することができます。ただし、当社は、次の各号のいずれかに該当する場合は、閉示を行わないことがあります。
                <ul className="list-[lower-alpha] ml-5">
                    <li>開示することでご本人様又は第三者の生命、身体、財産その他の権利利益を書するおそれがある場合</li>
                    <li>開示することで当社の業務の適正な実施に著しい支障を及ほすおそれがある場合</li>
              ...
              <li>訂正・追加・削除<br />お客様は、下記4に定める手続に従って、個人情報の訂正・追加・削除を請求することができます。その場合、当社は、利用目的の達成に必要な範囲内で遅滞なく調査を行い、その結果に基づき、個人情報保護法において認められる範囲内において、当該個人情報の訂正・追加・削除を行います。</li>
              ...
              <li>
                ...
                <ul className="list-[lower-alpha] ml-5">
                  ...
                  <li>
                    送付先<br />
                    〒102-0083<br />
                    住所　東京都千代田区麹町3−5−2ビュレックス麹町205<br />
