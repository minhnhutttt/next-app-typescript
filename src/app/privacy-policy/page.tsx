      ...
      <div className="px-5 mt-7 md:mt-10">
        ...
        <div className="mx-auto pb-16 pt-5 w-full max-w-[1000px] space-y-14 md:pb-20 md:pt-11">
          ...
          <TextBlock title="利用目的">
            当社は、お客様の個人情報を、次に掲げる利用目的（以下、「本利用目的」といいます。）の範囲内において取得及び利用いたします。
            <ol className="list-decimal ml-5">
              <li>
            ...
            <ol className="list-decimal ml-5">
              <li>
                ...
                <ul className="list-[lower-alpha] ml-5">
                  <li>
                  開示することでご本人様又は第三者の生命、身体、財産その他の権利利益を損なうおそれがある場合
                  </li>
                  <li>
          ...
          <TextBlock title="Cookie の取扱い">
            ...
            <ul className="list-[lower-alpha] ml-5">
              ...
              Cookieの概要
                <br />
                Cookieとは、任意の文字が書かれた小さなファイルのことで、お客様がウェブサイトを閲覧した際に、ウェブサーバとお客様のインターネット関覧ソフト（ブラウザ）との間でやりとりされ、お客様の端末に保存されるものです。これを利用することにより、お客様の閲覧履歴、サービス利用履歴、位置情報等、個人が特定できない属性情報を取得することがあります。
                <br />
