...
export default function Home() {
  return (
    <main className="px-5 py-10 md:py-[120px]">
        ...
        <br />
        For any questions or clarifications about our Privacy Policy, please don&apos;t hesitate to reach out to us at info@ultimate-holdings-group.com.<br />
        <br />
        ...
        <br />
        If you contact us directly, we may receive additional information about you, such as your name, email address, phone number, the contents of your message, any attachments you send, and any other information you choose to provide.<br />
        <br />
        ...
        <br />
        1. Operating and maintaining our website<br />
        2. Enhancing and personalizing user experience<br />
        3. Analyzing user behavior and preferences<br />
        4. Developing new products, services, and features<br />
        5. Communicating with you directly or through our partners for customer service, updates, and marketing purposes<br />
        ...
        <br />
        1. The right to request disclosure of personal data collected about them<br />
        ...
        <br />
        1. Right to access your personal data<br />
        2. Right to rectification of inaccurate or incomplete data<br />
        3. Right to erasure of your personal data<br />
        4. Right to restrict processing of your data<br />
        5. Right to object to processing of your data<br />
        6. Right to data portability<br />
        <br />
        ...
        <br />
        Email: info@ultimate-holdings-group.com<br />
        Website: <a href="ultimate-holdings-group.com" className="underline">ultimate-holdings-group.com</a>
