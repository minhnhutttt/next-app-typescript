export default function PrivacyPolicy() {
  return (
    <main className="mt-[95px]">
      <div className="px-5 w-full max-w-[1082px] mx-auto md:py-[74px] py-10">
        <p className="text-center md:text-[20px] text-[18px]">プライバシーポリシー</p>
        <p className="text-right md:text-[18px] text-[16px]">制定　2023.12.23</p>
        <div className="text-[12px] mt-7 md:mt-10">
            　お客様の個人情報の保護について、次のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定め、本ポリシーに基づき適正に個人情報を取り扱います。<br />
            なお、本ポリシーで使用する用語の意味は、個人情報の保護に関する法律（以下、「個人情報保護法」といいます。）に準拠するものとします。<br />
            <br />
            1.取得する個人情報の項目<br />
            ...
            （5）その他の情報<br />
            お客様から当社へのお問い合せ・ご連絡等に関する情報等<br />
            <br />
            1.利用目的<br />
            　当社は、お客様の個人情報を、次に掲げる利用目的（以下、「本利用目的」といいます。）の範囲内において、取得及び利用いたします。<br />
            サービスへの登録及びサービス利用時の本人確認並びにお客様の管理のため<br />
            商品等のお届け、ご提供、アフターサービスのため<br />
            商品等及びサービスの対価のご請求のため<br />
            不正行為等の防止及び対応のため<br />
            サービスの保守、管理のため<br />
            マーケティングデータの調査及び分析、並びに、マーケティング施策の検討及び実施のため<br />
            当社又は第三者の媒体において、お客様の属性・行動履歴の分析に基づく興味及び関心等に合わせ、当社又は第三者の商品等及びサービスの提供、勧誘、広告その他のマーケティングをするため
            キャンペーン、懸賞企画、アンケートの実施のため<br />
            商品等及びサービスの改善のため、並びに、新たな商品等及びサービスの企画、研究及び開発のため<br />
            お問い合わせ対応及びお客様へのご連絡のため<br />
            本ポリシー記載の方法による、第三者に対する提供<br />
            <br />
            1.第三者提供<br />
            （1）当社は、次に掲げる場合を除き、当社が取り扱う個人情報を、あらかじめお客様の同意を得ないで、第三者に提供いたしません。<br />
            1.法令に基づく場合<br />
            2.人の生命、身体又は財産の保護のために必要がある場合であって、お客様の同意を得ることが困難であるとき<br />
            3.公衆衛生の向上又は児童の健全な育成の推進のために特に必要がある場合であって、お客様の同意を得ることが困難であるとき<br />
            4,国の機関若しくは地方公共団体又はその委託を受けた者が法令の定める事務を遂行することに対して協力する必要がある場合であって、お客様の同意を得ることにより当該事務の遂行に支障を及ぼすおそれがあるとき<br />
            5.その他法令で認められる場合<br />
            <br />
            1.安全管理措置<br />
            当社は、その取り扱う個人情報の漏洩、滅失又は毀損の防止その他個人情報の安全管理のために、必要かつ適切な措置を講じます。当社が講じる安全管理措置については、第8項記載のお問い合わせ窓口までお問い合わせください。<br />
            <br />
            1.開示等の請求<br />
            当社は、次に定めるとおり開示後の請求（利用目的の通知、個人情報又は第三者提供記録の開示、訂正・追加・削除、利用の停止・第三者提供の停止の請求をいいます。）に対応します。<br />
            （1）利用目的の通知又は個人情報若しくは第三者提供記録の開示<br />
            お客様は、当社に対し、下記（4）に定める手続に従って、個人情報保護法において認められる範囲内において、利用目的の通知を求め、又は、個人情報若しくは第三者提供記録の開示を請求することができます。ただし、当社は、次の各号のいずれかに該当する場合は、開示を行わないことがあります。<br />
            1.開示することでご本人様又は第三者の生命、身体、財産その他の権利利益を害するおそれがある場合<br />
            2.開示することで当社の業務の適正な実施に著しい支障を及ぼすおそれがある場合<br />
            3.開示することが法令に違反することとなる場合<br />
            4.開示の請求がご本人様からであることが確認できない場合<br />
            ...
            匿名加工情報に関するお問い合わせは、第１０項記載のお問い合わせ窓口までご連絡ください。<br />
            <br />
            1.Cookie の取扱い<br />
            （1）Cookieの利用について<br />
            当社のウェブサイトでは、お客様により適切なサービスをご提供するためCookie（クッキー）その他のトラッキング又は解析を行うための類似技術（以下、総称して「Cookie」といいます。）を使用しております。<br />
            1.Cookieの概要<br />
            Cookieとは、任意の文字が書かれた小さなファイルのことで、お客様がウェブサイトを関覧した際に、ウェブサーバとお客様のインターネット閲覧ソフト（ブラウザ）との間でやりとりされ、お客様の端末に保存されるものです。これを利用することにより、お客様の閲覧履歴、サービス利用履歴、位置情報等、個人が特定できない属性情報を取得することがあります。<br />
            ...
            1.第三者が提供する閲覧履歴等の収集・分析サービスの利用について<br />
            ...
            GOOGLE：https://policies.google.com/technologies/partner-sites<br />
            Meta：https://www.facebook.com/legal/technology_terms　<br />
            株式会社Faber Company：https://mieru-ca.com/privacy-policy/　<br />
            <br />
            1.お問い合わせ窓口<br />
            　ご意見、ご質問、苦情のお申出その他個人情報の取扱いに関するお問い合わせは、下記の窓口までご連絡ください。<br />
            　　E-mail：info@dxb.plus<br />
