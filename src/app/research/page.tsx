...
const DataProvide = [
  ...
  },
  {
    id: '2',
    title: 'デザイン',
    content: <>ブランドイメージやユーザー体験を考慮しながら、視覚的な要素を作り上げます。UI/UXを最適化し、ユーザーフレンドリーなデザインを追求します。</>,
  },
  {
    id: '3',
    title: '開発',
...
const DataFaq = [
  ...
  },
  {
    ...
    content: <>費用は、サイトの規模や必要な機能、デザインの複雑さにより異なります。簡単なランディングページから大規模なEコマースサイトまで、プロジェクトごとにお見積もりいたします。</>,
  },
  {
    id: '3',
  ...
  },
  {
    ...
    content: <>もちろんです。私たちは、世界標準であるReactを採用し、スマートフォン、タブレット、PCなど、すべてのデバイスで快適に閲覧できるWebサイトを制作しています。幅広いデバイスに対応する、使いやすく高性能なWebサイトを提供いたします。</>,
  },
]
