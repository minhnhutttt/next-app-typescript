      ...
      <div className="container">
        ...
        <div>
          ...
          >
            ...
            <div className="img-container absolute bottom-[-100px] left-0 z-[-1] h-[calc(100%_+_100px)] w-[calc(100%_+_100px)] bg-[url('/assets/images/techno_researchi_shield.png')] bg-cover bg-center"></div>
          </a>
        </div>
      </div>
    </section>
