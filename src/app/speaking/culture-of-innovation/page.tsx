  ...
  return (
    <PageWrapper>
      <main className="bg-white relative">
        <PageHead head="Culture of Innovation/" title="Keynote">
          Discover what it really takes to build an
          organization where bold ideas thrive and progress
          never stalls. This keynote challenges leaders to rethink
          old habits and ignite a forward-thinking culture built for
          what's next.
        </PageHead>
        <Vision
