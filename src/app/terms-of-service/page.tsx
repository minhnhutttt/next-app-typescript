      ...
      <div className="mt-7 px-5 md:mt-10">
        <div className="mx-auto w-full max-w-[1000px] space-y-14 pb-16 pt-5 md:pb-20 md:pt-11">
          ...
          <TextBlock title="5. リンクについて">
            ...
            （雑誌・書籍の出版物等への本ウェブサイトURLの掲載も含みます）していただくことが可能です。特に、4.クーリングオフについておよび以下に定める各事項をご確認いただき、遵守いただきますようお願いいたします。また、リンクに際して、当社へのご連絡は不要です。（以下、本ウェブサイトから、もしくは本ウェブサイトへリンクを貼っている当社以外の第三者のウェブサイトを、「リンクサイト」といいます。）
