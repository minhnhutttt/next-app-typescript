    ...
    <main>
      ...
      <div className="mt-7 px-5 md:mt-10">
        <div className="mx-auto w-full max-w-[1000px] space-y-14 pb-16 pt-5 md:pb-20 md:pt-11">
          ...
          <TextBlock title="4. クーリングオフについて">
            本ウェブサイトを通じた当社の販売方法は通信販売のため、クーリングオフ制度の適用はございません。通信販売にはクーリングオフ制度が適用されないことをご理解ください。
          </TextBlock>
          <TextBlock title="5. 禁止行為">
          ...
          <TextBlock title="6. リンクについて">
            本ウェブサイトは、営利、非営利、インターネット、イントラネットを問わず、本ウェブサイトに定める全てのご利用条件に従っていただくことを条件に、リンク
            （雑誌・書籍の出版物等への本ウェブサイトURLの掲載も含みます）していただくことが可能です。特に、5.禁止行為および以下に定める各事項をご確認いただき、遵守いただきますようお願いいたします。また、リンクに際して、当社へのご連絡は不要です。（以下、本ウェブサイトから、もしくは本ウェブサイトへリンクを貼っている当社以外の第三者のウェブサイトを、「リンクサイト」といいます。）
          ...
          <TextBlock title="8. クッキー（Cookie）について">
