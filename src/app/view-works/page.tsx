...
const data = [
  {
    ...
    title: "Site 1",
    au: "",
    video01: "/assets/videos/SKALE_mov1-1.mp4",
    video02: "/assets/videos/SKALE_mov1-2.mp4",
    video03: "/assets/videos/SKALE_mov1-3.mp4",
  },
  {
    id: "02",
    client: "",
    title: "Site 2",
    au: "",
    video01: "/assets/videos/SKALE_mov2-1.mp4",
    video02: "/assets/videos/SKALE_mov2-2.mp4",
    video03: "/assets/videos/SKALE_mov2-3.mp4",
  },
  {
    id: "03",
    client: "",
    title: "Site 3",
    au: "",
    video01: "/assets/videos/SKALE_mov3-1.mp4",
    video02: "/assets/videos/SKALE_mov3-2.mp4",
    video03: "/assets/videos/SKALE_mov3-3.mp4",
  },
];
    ...
    <main ref={containerRef} className="bg-black overflow-hidden">
      <div className="pt-[2rem]">
        <div className="flex justify-center items-center py-5">
          <a href="/" className="">
            <img className="w-[70px]" src="/assets/images/logo.svg" alt="" />
          </a>
        </div>
        ...
        <div className="md:py-[13rem] py-[50vh] px-5 md:px-10">
          ...
          <div
            ...
            className="border-t border-white divide-y divide-white"
          >
            {data.map((item, index) => (
              <div
              ...
              >
                <span
                  className={`h-px bg-white absolute top-0 z-10 duration-500 inset-x-0 ${hoveredIndex === index ? "opacity-100" : "opacity-0"}`}
                ></span>
                <div
                  className={`fixed  inset-0 pointer-events-none duration-500 ${hoveredIndex === index ? "opacity-100" : "opacity-0"}`}
                >
                    ...
                    <div className="aspect-video w-[90vw] xl:w-[1200px] mx-auto absolute flex items-center justify-center ">
                      {hoveredIndex === index && (
                        <>
                          <LazyVideo
                            src={item.video01}
                            className="w-[58.75%] pointer-events-none relative"
                          />
                          <LazyVideo
                            src={item.video02}
                ...
                <span
                  className={`h-px bg-white absolute bottom-0 inset-x-0 ${hoveredIndex === index ? "opacity-100" : "opacity-0"}`}
                ></span>
              </div>
            ))}
          </div>
