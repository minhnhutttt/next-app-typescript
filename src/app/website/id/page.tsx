...
export default function WebsiteSingle() {
        ...
        <div className="flex">
            ...
            <div className="max-xl:hidden w-[295px] bg-[#E4E7F3] dark:bg-[#9C89D2]/[0.68] border-l border-[#A06778] dark:border-white flex flex-col justify-between">
                <div className="fade-up px-3 pt-6">
                    ...
                    <div className="w-[272px] mx-auto dark:text-white bg-white/70 dark:bg-white/30 border border-[#8686D6]/[0.7] dark:border-[#6476B5]/[0.7] p-2.5">
                        <p className="md:text-[13px] text-[15px] border-b border-[#8686D6] dark:border-white pb-1 font-semibold">イーロンマスク</p>
            ...
            <div className="w-[300px] md:w-[500px] mx-auto dark:text-white bg-white dark:bg-[#666666] border border-[#8686D6]/[0.7] dark:border-[#6476B5]/[0.7] p-2.5">
                        <p className="md:text-[17px] text-[15px] font-semibold border-b border-[#8686D6] dark:border-white pb-1">イーロンマスク</p>
