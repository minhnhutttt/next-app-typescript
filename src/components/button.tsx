...
const Button = ({ large = false, link = '#', children }: ButtonProps) => {
  return (
    <a
      ...
      className={`relative bg-[#73E3DC] md:rounded-[20px] rounded-[10px] flex justify-center items-center mx-auto md:h-20 h-16 max-w-[100%] text-[#000F12] text-center font-bold transition duration-300 tracking-wides gap-2
