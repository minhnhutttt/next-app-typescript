...
const Button = ({ children, href = "#" }: ButtonProps) => {
  ...
  return (
    <a href={href} className="group md:w-[473px] w-[320px] h-16 md:h-[84px] flex items-center overflow-hidden bg-[linear-gradient(90deg,_rgba(150,68,255,1)_0%,_rgba(236,98,98,1)_80%)] p-1.5 rounded-[42px]">
