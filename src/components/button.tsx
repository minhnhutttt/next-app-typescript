    ...
    <a href={href} className={`group md:w-[380px] w-[320px] h-16 md:h-20  flex items-center overflow-hidden ${white ? 'bg-white' : 'bg-black'}`}>
      <div className="flex items-center h-full">
        ...
        <svg className="max-md:w-16" xmlns="http://www.w3.org/2000/svg" width="115" height="17" viewBox="0 0 115 17" fill="none">
            <line y1="15.7778" x2="115" y2="15.7778" stroke={`${white ? 'black' : 'white'}`} strokeWidth="2"/>
            <line x1="114.071" y1="16.2633" x2="98.5147" y2="0.70691" stroke={`${white ? 'black' : 'white'}`} strokeWidth="2"/>
        </svg>
        </span>
        <div className={`overflow-hidden px-6 relative font-anton text-[14px] md:text-[18px] ${white ? 'text-black' : 'text-white'}`}>
