...
export const Button = ({ link, children, type = 1, sm = false, disable = false, onClick }: ButtonProps) => {
  const baseClass = `relative flex items-center justify-center md:text-[24px] text-[18px] font-bold border-2 px-4 rounded-[10px] hover:mt-1 duration-300 hover:shadow-none ${
    type === 0
