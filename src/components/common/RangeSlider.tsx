    ...
    <div className="w-full max-w-md mx-auto">
      <div className="relative h-1 bg-gray-300 rounded my-2.5">
        ...
        <input
          ...
          style={{ zIndex: minValue > 100 - 10 ? 5 : 3 }}
        />
        <input
          type="range"
          min={0}
      ...
      <div className="flex justify-between mt-4">
        <span className="md:text-[18px] text-[16px] font-bold">{minValue}円以下</span>
        <span className="md:text-[18px] text-[16px] font-bold">{maxValue}円以上</span>
      </div>
    </div>
  );
}
