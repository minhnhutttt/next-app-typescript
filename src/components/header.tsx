  ...
  return (
    <header className="flex items-center absolute top-0 inset-x-0 px-3 z-40">
      <div className="w-full flex items-center justify-between">
        <div className="flex items-center justify-between md:pl-4 lg:pl-14 pr-4 md:pr-10 md:pt-8 pt-4">
        ...
        <div
          className={`max-xl:fixed px-5 max-xl:left-0 max-xl:top-0 max-xl:h-screen max-xl:w-full max-xl:bg-[#EB6642]/[0.9] z-10 max-xl:overflow-y-scroll flex items-center justify-center max-xl:flex-col ${
        ...
        <button
          className={`group relative z-30 h-6 w-8  max-lg:mt-5 xl:hidden mr-6 ${
            NavOpen ? "active" : ""
          }`}
