  ...
  return (
    <footer className="pb-[3vw] md:pt-[3vw] bg-black overflow-hidden text-white js-sfoot">
      <div className="will-change-transform js-sfoot-inner">
        <div className="grid gap-y-[6vw] grid-cols-12 md:grid-cols-[repeat(24,_minmax(0,_1fr))] gap-x-[2vw] pt-[16vw] md:pt-0 pb-[12vw] md:pb-[20vw] px-[4vw] md:px-[2vw]">
        ...
        <div className="border-t border-white border-opacity-25 px-[4vw] md:px-[2vw]">
          <div className="grid grid-cols-12 md:grid-cols-[repeat(24,_minmax(0,_1fr))] gap-y-[10vw] pt-[10vw] md:pt-[2vw] pb-[20vw] md:pb-[20vw] gap-x-[2vw] font-semibold">
          ...
          <div className="grid gap-y-[5vw] grid-cols-12 md:grid-cols-[repeat(24,_minmax(0,_1fr))] gap-x-[2vw] md:text-[1.5vw] text-[4vw]">
