      ...
      <div>
        <div className="w-full max-w-[510px] mx-auto">
          ...
          <div className="w-full flex justify-center h-[65px] md:h-[clamp(1px,11.273vh,124px)]">
              <a href="https://line.me/R/ti/p/%40300kbcvu" target="_blank" className="w-full max-w-[510px] h-[60px] md:h-[clamp(1px,10.455vh,115px)] gap-3 relative md:rounded-[24px] rounded-[10px] md:text-[clamp(1px,2.545vh,28px)] text-[20px] text-white font-black bg-[#01B902] flex items-center justify-center hover:border-b md:border-b-[9px] border-b-[5px] md:hover:mt-[8px] hover:mt-[4px] border-[#005800] duration-200 tracking-[0.2em]">
