...
const Menu = () => {
  ...
  return (
    <div className="md:mt-12 md:pt-5 w-full md:w-[250px]">
        ...
        <div ref={boxRef} className={`md:!hidden md:px-2 max-md:fixed max-md:right-0 max-md:top-1/2 max-md:-translate-y-1/2 max-md:max-h-[90%] h-full max-md:max-w-[80%] max-md:w-full max-md:rounded-[25px] max-md:rounded-r-none z-[99] max-md:bg-[#F2F0E6]/[0.98] dark:bg-black/[0.98] max-md:border max-md:border-[#797979] max-md:translate-x-full origin-right flex flex-col`}>
        <button
        ...
        >
          <Anime />
            ...
            <p className="md:hidden pt-6 pb-[18px] px-[18px] border-b-4 border-[#464646] dark:border-[#C6C6C6] flex-1 text-[24px] font-bold italic text-[#464646] dark:text-[#C6C6C6]">
                RANKING
            </p>
