...
const Contact = () => {
  return (
    <div className="fade-up px-5 pb-30 md:pb-50">
      <h5 className="text-center text-[19.44vw] font-semibold min-[1440px]:text-[280px]">
        CONTACT
      </h5>
      <div className="md:px-10">
        <Link
          href="/"
          className="mx-auto block w-full max-w-[1060px] rounded-[16px] md:rounded-[32px]"
        >
