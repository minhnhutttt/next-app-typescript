(function(root, factory) {
    ...
    function setup(userConfig = {}) {
      ...
      if (config.auto) {
        ...
        buttonOrigin = config.originElement || document.querySelector(".button-starfield-origin");
        if (!origin) {
        ...
        buttonOrigin.addEventListener("mouseenter", mouseEnterHandler);
        buttonOrigin.addEventListener("mouseleave", mouseLeaveHandler);
